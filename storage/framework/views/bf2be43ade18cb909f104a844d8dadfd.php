...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'f4ac99e09542ff494432bc959d4fee61::admin','data' => ['title' => 'Gallery Settings']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Gallery Settings']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

    <div
        class="mx-auto max-w-3xl space-y-8 p-8"
        x-data="{
        metrics: <?php echo e(json_encode($settings['gallery_metrics'])); ?>,
        addMetric() {
    ...
    >
        <div class="flex items-center justify-between">
            ...
            <a href="<?php echo e(route('admin.gallery.index')); ?>" class="admin-action-btn admin-action-btn-ghost"
                >Back to Gallery</a>
        </div>

        <form
            action="<?php echo e(route('admin.gallery-settings.update')); ?>"
            method="POST"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Highblossom\resources\views\admin\gallery\settings.blade.php ENDPATH**/ ?>