...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'f4ac99e09542ff494432bc959d4fee61::admin','data' => ['title' => 'SMTP Settings']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'SMTP Settings']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="mx-auto max-w-5xl space-y-8 py-10">
        ...
        <form action="<?php echo e(route('admin.smtp.update')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div class="space-y-2">
                                ...
                                >
                                    <option
                                        value="smtp"
                                        <?php echo e(old('mail_mailer', $settings['mail_mailer']) === 'smtp' ? 'selected' : ''); ?>
                                    ...
                                    <option
                                        value="sendmail"
                                        <?php echo e(old('mail_mailer', $settings['mail_mailer']) === 'sendmail' ? 'selected' : ''); ?>
                                    ...
                                    <option
                                        value="log"
                                        <?php echo e(old('mail_mailer', $settings['mail_mailer']) === 'log' ? 'selected' : ''); ?>
                            ...
                            <div class="space-y-2">
                                ...
                                >
                                    <option
                                        value="tls"
                                        <?php echo e(old('mail_encryption', $settings['mail_encryption']) === 'tls' ? 'selected' : ''); ?>
                                    ...
                                    <option
                                        value="ssl"
                                        <?php echo e(old('mail_encryption', $settings['mail_encryption']) === 'ssl' ? 'selected' : ''); ?>
                                    ...
                                    <option
                                        value=""
                                        <?php echo e(old('mail_encryption', $settings['mail_encryption']) === '' ? 'selected' : ''); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Highblossom\resources\views\admin\smtp\index.blade.php ENDPATH**/ ?>