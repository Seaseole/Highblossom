<div class="w-full lg:w-2/3">
    <div class="bg-white rounded-md overflow-hidden border border-gray-200">
        <div class="bg-gray-50 px-4 py-3 border-b border-gray-200 flex flex-wrap items-center gap-2">
            <span class="text-gray-500"> <?php echo $svgIcons['composer']; ?> </span>
...
</div><?php /**PATH C:\laragon\www\Highblossom\vendor\lubusin\laravel-decomposer\src\views\components\packages_datatable.blade.php ENDPATH**/ ?>