...
<?php endif; ?>
    ...
    <?php if ($name) { ?>
    <span class="mx-2 truncate text-sm font-medium text-zinc-500 group-hover:text-zinc-800 in-data-flux-sidebar-collapsed-desktop:hidden dark:text-white/80 dark:group-hover:text-white">
        <?php echo e($name); ?>
    ...
    <div class="ms-auto flex size-8 shrink-0 items-center justify-center in-data-flux-sidebar-collapsed-desktop:hidden">
...
<?php /**PATH C:\laragon\www\Highblossom\resources\views\flux\sidebar\profile.blade.php ENDPATH**/ ?>