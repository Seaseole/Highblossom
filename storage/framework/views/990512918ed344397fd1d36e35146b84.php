...
<div
    x-data="{
        items: <?php if ((object) ($wireModel) instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e($wireModel->value()); ?>')<?php echo e($wireModel->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e($wireModel); ?>')<?php endif; ?>,
        fieldDefs: <?php echo e(json_encode($fields)); ?>,
        init() {
...
>
    ...
    >
        ...
        <span class="text-sm font-medium">Add <?php echo e(rtrim($label, 's')); ?></span>
    </button>
    ...
    <div x-show="items.length === 0" class="py-6 text-center text-[#71717A]">
        ...
        <p class="text-sm">No <?php echo e(strtolower($label)); ?> yet. Click above to add.</p>
    </div>
</div>
<?php /**PATH C:\laragon\www\Highblossom\resources\views\components\admin\repeater-field.blade.php ENDPATH**/ ?>