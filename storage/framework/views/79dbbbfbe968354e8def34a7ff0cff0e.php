...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'f4ac99e09542ff494432bc959d4fee61::admin','data' => ['title' => 'Inspection Details']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Inspection Details']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="mx-auto max-w-5xl space-y-8 py-10">
        ...
        <div class="space-y-1">
            <a
                href="<?php echo e(route('admin.inspections.index')); ?>"
            ...
            <h1 class="font-headline text-3xl font-semibold text-gray-900 dark:text-white">
                Inspection #<?php echo e($inspection->id); ?>
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                ...
                <dl class="space-y-4">
                    <div class="space-y-1">
                        ...
                        <dd class="text-sm font-medium text-gray-900 dark:text-white">
                            <?php echo e($inspection->scheduled_at->format('F j, Y g:i A')); ?>

                        </dd>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inspection->ended_at): ?>
                        <div class="space-y-1">
                            ...
                            <dd class="text-sm font-medium text-emerald-600 dark:text-emerald-400">
                                <?php echo e($inspection->ended_at->format('F j, Y g:i A')); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <dd class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($inspection->location); ?></dd>
                    </div>
                    <div class="space-y-1">
            ...
            <div class="space-y-6 rounded-3xl border border-gray-200 bg-white p-8 shadow-sm dark:border-white/10 dark:bg-[#0A0A0F]">
                ...
                <dl class="space-y-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inspection->staff): ?>
                        <div class="space-y-1">
                            ...
                            <dd class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($inspection->staff->email); ?></dd>
                        </div>
                    <?php else: ?>
                        <div class="space-y-1">
                            <dt class="text-xs font-semibold tracking-wider text-gray-500 uppercase">Staff</dt>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inspection->booking): ?>
                        <div class="space-y-1 border-t border-gray-100 pt-4 dark:border-white/10">
                            ...
                            <dd class="text-sm font-medium text-gray-900 dark:text-white">
                                ...
                                >
                                    Booking #<?php echo e($inspection->booking->id); ?>
            ...
            <div class="space-y-6 rounded-3xl border border-gray-200 bg-white p-8 shadow-sm dark:border-white/10 dark:bg-[#0A0A0F]">
                ...
                <form action="<?php echo e(route('admin.inspections.update', $inspection)); ?>" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        >
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $staffMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <option
                                    value="<?php echo e($user->id); ?>"
                                    <?php echo e($inspection->staff_id === $user->id ? 'selected' : ''); ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            type="datetime-local"
                            name="scheduled_at"
                            value="<?php echo e($inspection->scheduled_at->format('Y-m-d\TH:i')); ?>"
                            class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm transition-all outline-none focus:ring-1 focus:ring-gray-900 dark:border-white/10 dark:bg-white/5 dark:focus:ring-[var(--color-admin-accent)]"
                        />
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            type="datetime-local"
                            name="ended_at"
                            value="<?php echo e($inspection->ended_at ? $inspection->ended_at->format('Y-m-d\TH:i') : ''); ?>"
                            class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm transition-all outline-none focus:ring-1 focus:ring-gray-900 dark:border-white/10 dark:bg-white/5 dark:focus:ring-[var(--color-admin-accent)]"
                        />
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <input
                            type="text"
                            name="location"
                            value="<?php echo e($inspection->location); ?>"
                            class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm transition-all outline-none focus:ring-1 focus:ring-gray-900 dark:border-white/10 dark:bg-white/5 dark:focus:ring-[var(--color-admin-accent)]"
                        />
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <select
                            ...
                            class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm transition-all outline-none focus:ring-1 focus:ring-gray-900 dark:border-white/10 dark:bg-white/5 dark:focus:ring-[var(--color-admin-accent)]"
                        >
                            <option value="mobile" <?php echo e($inspection->type === 'mobile' ? 'selected' : ''); ?>>
                                Mobile
                            </option>
                            <option value="workshop" <?php echo e($inspection->type === 'workshop' ? 'selected' : ''); ?>>
                                Workshop
                            </option>
                        </select>
                    </div>
                ...
                <!-- Delete Action -->
                <form
                    action="<?php echo e(route('admin.inspections.destroy', $inspection)); ?>"
                    method="POST"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Highblossom\resources\views/admin/inspections/show.blade.php ENDPATH**/ ?>