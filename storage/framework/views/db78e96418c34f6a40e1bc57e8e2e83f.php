...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'f4ac99e09542ff494432bc959d4fee61::admin','data' => ['title' => 'Create Glass Type']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Create Glass Type']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="mx-auto max-w-5xl space-y-8 py-10">
        ...
        <div class="flex items-center justify-between">
            <div class="space-y-1">
                <h1 class="font-headline text-3xl font-semibold text-gray-900 dark:text-white">Create Glass Type</h1>
                <p class="text-gray-500 dark:text-gray-400">Define a new architectural glass variant for the system.</p>
            </div>
            <a
        ...
        <form
            method="POST"
            action="<?php echo e(route('admin.glass-types.store')); ?>"
                ...
                <div class="space-y-6 rounded-3xl border border-gray-200 bg-white p-8 shadow-sm dark:border-white/10 dark:bg-[#0A0A0F]">
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g. Laminated Structural Glass"
                        />
                    </div>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Highblossom\resources\views\admin\glass-types\create.blade.php ENDPATH**/ ?>