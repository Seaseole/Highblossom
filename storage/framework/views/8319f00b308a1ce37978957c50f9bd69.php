...
<?php if ($as !== 'button') { ?>
<a <?php echo e($attributes->class($classes)); ?> data-flux-link <?php if ($external) { ?>target="_blank" <?php } ?>><?php echo e($slot); ?></a>
<?php } else { ?>
<button <?php echo e($attributes->merge(['class' => $classes, 'type' => 'button'])); ?> data-flux-link><?php echo e($slot); ?></button>
<?php } ?>
<?php /**PATH C:\laragon\www\Highblossom\resources\views\flux\link.blade.php ENDPATH**/ ?>