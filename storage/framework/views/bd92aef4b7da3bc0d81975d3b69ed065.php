...
<a href="<?php echo e($href); ?>" <?php echo e($attributes->class([ $classes, 'gap-2' ])); ?> data-flux-sidebar-brand>
    ...
    <div class="flex h-6 min-w-6 shrink-0 items-center justify-center overflow-hidden rounded-sm">
        ...
        <img src="<?php echo e($logoDark); ?>" alt="<?php echo e($alt); ?>" class="hidden h-6 min-w-6 dark:block" />
        <?php } elseif ($logo) { ?>
...
<a href="<?php echo e($href); ?>" <?php echo e($attributes->class($classes)); ?> data-flux-sidebar-brand>
    ...
    <div class="flex h-6 shrink-0 items-center justify-center overflow-hidden rounded-sm">
        ...
        <img src="<?php echo e($logoDark); ?>" alt="<?php echo e($alt); ?>" class="hidden h-6 dark:block" />
        <?php } elseif ($logo) { ?>
...
<?php } ?>
<?php /**PATH C:\laragon\www\Highblossom\resources\views\flux\sidebar\brand.blade.php ENDPATH**/ ?>