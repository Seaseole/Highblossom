...
<?php endif; ?>
    ...
    <?php if ($name) { ?>
    <span class="mx-2 truncate text-sm font-medium text-zinc-500 group-hover:text-zinc-800 dark:text-white/80 dark:group-hover:text-white">
        <?php echo e($name); ?>
...
<?php /**PATH C:\laragon\www\Highblossom\resources\views\flux\profile.blade.php ENDPATH**/ ?>