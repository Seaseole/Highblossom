...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'f4ac99e09542ff494432bc959d4fee61::admin','data' => ['title' => 'Edit Testimonial']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Testimonial']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="mx-auto max-w-2xl space-y-8 py-10">
        ...
        <form
            method="POST"
            action="<?php echo e(route('admin.testimonials.update', $testimonial)); ?>"
        ...
        >
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    ><?php echo e(old('content', $testimonial->content)); ?></textarea>
                </div>
                ...
                <div class="flex items-center gap-6">
                    ...
                    <label class="flex cursor-pointer items-center gap-2">
                        <input
                            ...
                            name="is_published"
                            value="1"
                            <?php echo e(old('is_published', $testimonial->is_published) ? 'checked' : ''); ?>
                ...
                <div>
                    ...
                    <input
                        ...
                        name="sort_order"
                        id="sort_order"
                        value="<?php echo e(old('sort_order', $testimonial->sort_order)); ?>"
                        class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm transition-all outline-none focus:ring-2 focus:ring-gray-900 dark:border-white/10 dark:bg-white/5 dark:focus:ring-white"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Highblossom\resources\views\admin\testimonials\edit.blade.php ENDPATH**/ ?>