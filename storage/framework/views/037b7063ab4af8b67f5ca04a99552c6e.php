...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'f4ac99e09542ff494432bc959d4fee61::admin','data' => ['title' => 'Edit Role']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Role']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="mx-auto max-w-xl space-y-8 py-10">
        ...
        <div class="flex items-center justify-between">
            <div class="space-y-1">
                <h1 class="font-headline text-3xl font-semibold text-gray-900 dark:text-white">Edit Role</h1>
        ...
        <form
            method="POST"
            action="<?php echo e(route('admin.roles.update', $role)); ?>"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Highblossom\resources\views\admin\roles\edit.blade.php ENDPATH**/ ?>