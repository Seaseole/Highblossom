...
<head>
    ...
    <title>New Contact Message - <?php echo e($companyName); ?></title>
    <style type="text/css">
        /* Basic Reset */
                    ...
                    <tr>
                        <td bgcolor="#DC2626" style="padding: 24px 40px;">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td>
                                        <h1 style="color: #ffffff; font-size: 16px; font-weight: 700; margin: 0; text-transform: uppercase; letter-spacing: 2px;"><?php echo e($companyName); ?></h1>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 40px; border-bottom: 1px solid #374151; padding-bottom: 32px;">
                                <tr>
                                    <td width="50%" class="stack" valign="top" style="padding-bottom: 20px;">
                                        ...
                                        <p style="font-size: 15px; color: #FAFAFA; margin: 0; font-weight: 600;"><?php echo e($contactMessage->name); ?></p>
                                    </td>
                                    <td width="50%" class="stack" valign="top">
                                        ...
                                        <p style="font-size: 15px; color: #FAFAFA; margin: 0; font-weight: 600;"><?php echo e($contactMessage->subject); ?></p>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="50%" class="stack" valign="top" style="padding-top: 20px;">
                                        ...
                                        <p style="font-size: 13px; color: #DC2626; margin: 0; font-weight: 600;"><?php echo e($contactMessage->email); ?></p>
                                    </td>
                                    ...
                                    <td width="50%" class="stack" valign="top" style="padding-top: 20px;">
                                        ...
                                        <p style="font-size: 13px; color: #FAFAFA; margin: 0; font-weight: 600;"><?php echo e($contactMessage->phone); ?></p>
                                    </td>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 40px;">
                                <tr>
                                    <td>
                                        <p style="font-size: 11px; color: #6B7280; margin: 0; text-transform: uppercase; letter-spacing: 1px;">Received: <?php echo e($contactMessage->created_at->format('d M Y | H:i T')); ?></p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center">
                                        <a href="mailto:<?php echo e($contactMessage->email); ?>" style="display: block; padding: 16px 24px; background-color: #ffffff; color: #111827; font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: 2px; border-radius: 4px;">Direct Reply to Customer</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
...
<?php /**PATH C:\laragon\www\Highblossom\resources\views\emails\contact.blade.php ENDPATH**/ ?>