...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div <?php echo e($attributes->only('class')->class('w-full relative block group/input')); ?> data-flux-input>
        ...
        <div class="pointer-events-none absolute start-0 top-0 bottom-0 flex items-center justify-center border-s border-transparent ps-3 text-xs text-zinc-400/75 dark:text-white/60">
...
<?php endif; ?>
        ...
        <input
            ...
            <?php } ?>
            <?php if ($maskDynamic) { ?>
            x-mask:dynamic="<?php echo e($maskDynamic); ?>"
            <?php elseif($mask): ?>
            x-mask="<?php echo e($mask); ?>"
            <?php } ?>
            ...
            <?php if ($loading) { ?>
            wire:loading.class="<?php echo e($inputLoadingClasses); ?>"
            <?php } ?>
            <?php if ($loading && $wireTarget) { ?>
            wire:target="<?php echo e($wireTarget); ?>"
            <?php } ?>
        />

        <?php if ($loading || $countOfTrailingIcons > 0) { ?>
        <div class="absolute end-0 top-0 bottom-0 flex items-center gap-x-1.5 border-e border-transparent pe-2 text-xs text-zinc-400">
...
<button <?php echo e($attributes->merge(['type' => 'button'])->class([$classes, 'w-full relative flex'])); ?>>
    <?php if (is_string($iconLeading)) { ?>
    <div class="absolute start-0 top-0 bottom-0 flex items-center justify-center ps-3 text-xs text-zinc-400/75">
        <?php if (isset($component)) { $__componentOriginalc7d5f44bf2a2d803ed0b55f72f1f82e2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc7d5f44bf2a2d803ed0b55f72f1f82e2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.index','data' => ['icon' => $iconLeading,'variant' => $iconVariant,'class' => $iconClasses]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::icon'); ?>
...
<?php endif; ?>
    ...
    <?php } else { ?>
    <div class="flex-1 self-center text-start font-medium text-zinc-800 dark:text-white"><?php echo e($slot); ?></div>
    <?php } ?>

    <?php if ($kbd) { ?>
    <div class="absolute end-0 top-0 bottom-0 flex items-center justify-center pe-4 text-xs text-zinc-400/75">
        <?php echo e($kbd); ?>
    ...
    <?php if (is_string($iconTrailing)) { ?>
    <div class="absolute end-0 top-0 bottom-0 flex items-center justify-center pe-3 text-xs text-zinc-400/75">
        <?php if (isset($component)) { $__componentOriginalc7d5f44bf2a2d803ed0b55f72f1f82e2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc7d5f44bf2a2d803ed0b55f72f1f82e2 = $attributes; } ?>
...
<?php } ?>
<?php /**PATH C:\laragon\www\Highblossom\resources\views\flux\input\index.blade.php ENDPATH**/ ?>