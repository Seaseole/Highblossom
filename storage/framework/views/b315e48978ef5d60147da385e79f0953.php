...
<header <?php echo e($attributes->class($classes)); ?> data-flux-header>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($container): ?>
        <div class="mx-auto flex h-full w-full items-center px-6 lg:px-8 [:where(&)]:max-w-7xl"><?php echo e($slot); ?></div>
    <?php else: ?>
        <?php echo e($slot); ?>

    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</header>
<?php /**PATH C:\laragon\www\Highblossom\resources\views\flux\header.blade.php ENDPATH**/ ?>