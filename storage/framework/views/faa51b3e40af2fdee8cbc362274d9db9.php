...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'f4ac99e09542ff494432bc959d4fee61::admin','data' => ['title' => 'Edit Service']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Service']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="mx-auto max-w-5xl space-y-8 py-10">
        ...
        >
            ...
            <input type="hidden" name="image_path" value="<?php echo e($service->image ?? ''); ?>" />
                ...
                <div class="space-y-6 rounded-3xl border border-gray-200 bg-white p-8 shadow-sm dark:border-white/10 dark:bg-[#0A0A0F]">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            required
                            class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm transition-all outline-none focus:ring-2 focus:ring-gray-900 dark:border-white/10 dark:bg-white/5 dark:focus:ring-white"
                        ><?php echo e(old('short_description', $service->short_description)); ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="6"
                            class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm transition-all outline-none focus:ring-2 focus:ring-gray-900 dark:border-white/10 dark:bg-white/5 dark:focus:ring-white"
                        ><?php echo e(old('full_description', $service->full_description)); ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        ><?php echo e(old('features', is_array($service->features) ? implode("\n", $service->features) : '')); ?></textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-6 rounded-3xl border border-gray-200 bg-white p-8 shadow-sm dark:border-white/10 dark:bg-[#0A0A0F]">
                    ...
                    >
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($service->image): ?>
                            <img src="<?php echo e($service->image); ?>" class="h-full w-full rounded-2xl object-cover" />
                        <?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Highblossom\resources\views\admin\services\edit.blade.php ENDPATH**/ ?>