...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Auditify Dashboard'); ?></title>
    <!-- Dynamic theme script to prevent FOUC (flash of unstyled content) -->
    <script>
        (function() {
            const savedTheme = localStorage.getItem('auditify-theme') || '<?php echo e(config('auditify.theme', 'dark')); ?>';
...
<body>
    ...
    <div class="app-container">
        ...
        <div class="mobile-header">
            ...
            <a href="<?php echo e(url(config('auditify.route_prefix', 'auditify'))); ?>" class="mobile-brand">
        ...
        <!-- Sidebar Navigation -->
        <aside class="sidebar">
            <a href="<?php echo e(url(config('auditify.route_prefix', 'auditify'))); ?>" class="brand">
                ...
                <span class="brand-name">Auditify <span class="brand-badge">v1.0.2</span></span>
            </a>
            ...
            <nav style="flex-grow: 1;">
                <ul class="nav-menu">
                    ...
                    <li class="nav-item <?php echo e($isActionLogs ? 'active' : ''); ?>">
                        <a href="<?php echo e(url($prefix . '/action-logs')); ?>">
                            <!-- Table Changes Icon -->
                            <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="nav-item <?php echo e($isActivityLogs ? 'active' : ''); ?>">
                        <a href="<?php echo e(url($prefix . '/activity-logs')); ?>">
                    ...
                    <li class="nav-item <?php echo e($isSecurityLogs ? 'active' : ''); ?>" style="position: relative;">
                        <a href="<?php echo e(url($prefix . '/security-logs')); ?>">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unreadSecurityCount > 0): ?>
                                <span class="sidebar-badge"><?php echo e($unreadSecurityCount); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </a>
                    </li>
                    
                    <!-- Reports -->
                    <li class="nav-item <?php echo e($isReports ? 'active' : ''); ?>">
                        <a href="<?php echo e(url($prefix . '/reports')); ?>">
                            <!-- Chart/Report Icon -->
                            <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="sidebar-footer">
                &copy; <?php echo e(date('Y')); ?> Arpa Nihan
            </div>
        </aside>
        ...
        <main class="main-wrapper">
            <div class="page-header">
                <div>
                    <h1 class="page-title"><?php echo $__env->yieldContent('header_title', 'Auditify'); ?></h1>
                </div>
                <div class="header-actions">
                    ...
                    <div class="notification-bell-container">
                        <button class="bell-btn" id="bellBtn" onclick="toggleBellDropdown(event)">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bellUnreadCount > 0): ?>
                        ...
                        <div class="bell-dropdown" id="bellDropdown">
                            <div class="bell-dropdown-header">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bellUnreadCount > 0): ?>
                                    <span class="badge" style="background-color: rgba(239, 68, 68, 0.15); color: #ef4444; font-size: 10px;"><?php echo e($bellUnreadCount); ?> New</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <ul class="bell-dropdown-list">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $bellAlerts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <li>
                                        <a href="<?php echo e(url($prefix . '/security-logs/' . $alert->id)); ?>" class="bell-dropdown-item">
                                            <div class="bell-dropdown-indicator indicator-<?php echo e($alert->severity); ?>"></div>
                                            <div class="bell-dropdown-info">
                                                <div class="bell-dropdown-title"><?php echo e($alert->title); ?></div>
                                                <div class="bell-dropdown-desc"><?php echo e($alert->description); ?></div>
                                                <div class="bell-dropdown-time"><?php echo e($alert->created_at->diffForHumans()); ?></div>
                                            </div>
                                        </a>
                                    </li>
                            ...
                            <div class="bell-dropdown-footer">
                                <a href="<?php echo e(url($prefix . '/security-logs')); ?>">View All Alerts</a>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        const serverUnreadCount = <?php echo e($bellUnreadCount); ?>;
        ...
        function pollUnreadAlerts() {
            const checkUrl = "<?php echo e(url(config('auditify.route_prefix', 'auditify') . '/security-logs/unread-check')); ?>";
            fetch(checkUrl)
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            ?>
            <?php if($pollingInterval > 0): ?>
                setInterval(pollUnreadAlerts, <?php echo e($pollingInterval * 1000); ?>);
            <?php endif; ?>
...
<?php /**PATH C:\laragon\www\Highblossom\vendor\arpanihan\auditify\src/../resources/views/layout.blade.php ENDPATH**/ ?>