<?php $__env->startSection('title', 'Auditify Overview Dashboard'); ?>
<?php $__env->startSection('header_title', 'Overview Dashboard'); ?>
...
<div class="grid-4">
    <div class="kpi-card">
        ...
        <span class="kpi-value"><?php echo e(number_format($totalActionLogs)); ?></span>
    ...
    <div class="kpi-card">
        ...
        <span class="kpi-value"><?php echo e(number_format($totalActivityLogs)); ?></span>
        <div class="kpi-subtext">
    ...
    <div class="kpi-card">
        ...
        <span class="kpi-value"><?php echo e(number_format($totalSecurityLogs)); ?></span>
        <div class="kpi-subtext">
    ...
    <div class="kpi-card">
        ...
        <span class="kpi-value" style="color: <?php echo e($unreadSecurityLogsCount > 0 ? '#f59e0b' : 'var(--kpi-text-color)'); ?>"><?php echo e(number_format($unreadSecurityLogsCount)); ?></span>
        <div class="kpi-subtext">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unreadSecurityLogsCount > 0): ?>
...
<div class="grid-2-1">
    ...
    <div class="card">
        ...
        <div class="module-list">
            ...
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $topModules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div class="module-item">
                    <div class="module-info">
                        <span class="module-name"><?php echo e($mod->module); ?></span>
                        <span class="module-count"><?php echo e($mod->count); ?> changes</span>
                    </div>
                    <div class="progress-bar">
                        <div class="progress-fill" style="width: <?php echo e(($mod->count / $maxModuleCount) * 100); ?>%"></div>
                    </div>
                </div>
...
<div class="grid-2">
    ...
    <div class="card">
        ...
        <div class="breakdown-list">
            <div class="breakdown-item">
                ...
                <div class="breakdown-val" style="color: var(--accent-create)"><?php echo e(number_format($createLogs)); ?></div>
            </div>
            <div class="breakdown-item">
                <div class="breakdown-label">UPDATE</div>
                <div class="breakdown-val" style="color: var(--accent-update)"><?php echo e(number_format($updateLogs)); ?></div>
            </div>
            <div class="breakdown-item">
                <div class="breakdown-label">DELETE</div>
                <div class="breakdown-val" style="color: var(--accent-delete)"><?php echo e(number_format($deleteLogs)); ?></div>
            </div>
            <div class="breakdown-item">
                <div class="breakdown-label">RESTORE</div>
                <div class="breakdown-val" style="color: #06b6d4"><?php echo e(number_format($restoreLogs)); ?></div>
            </div>
            <div class="breakdown-item">
                <div class="breakdown-label">APPROVE</div>
                <div class="breakdown-val" style="color: #0ea5e9"><?php echo e(number_format($approveLogs)); ?></div>
            </div>
            <div class="breakdown-item">
                <div class="breakdown-label">REJECT</div>
                <div class="breakdown-val" style="color: #64748b"><?php echo e(number_format($rejectLogs)); ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="user-list">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $topUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div class="user-item">
                    <div class="user-avatar">
                        <?php echo e(substr($topUser->user->name ?? 'G', 0, 2)); ?>

                    </div>
                    <div class="user-info">
                        <div class="user-name"><?php echo e($topUser->user->name ?? 'Guest User'); ?></div>
                        <div class="user-email">
                            ...
                            ?>
                            <?php echo e(implode(' • ', $details) ?: 'no-credentials@guest.com'); ?>

                        </div>
                    </div>
                    <span class="user-count"><?php echo e($topUser->count); ?> events</span>
                </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                <div style="text-align: center; color: var(--text-muted); font-size: 0.8rem; padding: 40px 0;">
                    No active user logs.
...
<div class="grid-2">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div class="timeline-item">
                    <div class="timeline-badge">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(str_contains(strtolower($activity->activity), 'login') && !str_contains(strtolower($activity->activity), 'failed')): ?>
                            🔓
                        <?php elseif(str_contains(strtolower($activity->activity), 'logout')): ?>
                            🔒
                        <?php elseif(str_contains(strtolower($activity->activity), 'failed')): ?>
                            ❌
                        <?php else: ?>
                            🌐
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="timeline-content">
                        <div class="timeline-title"><?php echo e($activity->activity); ?></div>
                        <div class="timeline-desc"><?php echo e($activity->user->name ?? 'Guest'); ?> performed this interaction.</div>
    ...
    <div class="card">
        ...
        <div class="security-timeline">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentSecurityLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $security): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <a href="<?php echo e(url(config('auditify.route_prefix', 'auditify') . '/security-logs/' . $security->id)); ?>" class="security-item">
                    <div class="security-indicator indicator-<?php echo e($security->severity); ?>"></div>
                    <div class="security-details">
                        <div style="display: flex; justify-content: space-between; align-items: center; gap: 8px; flex-wrap: wrap;">
                            <span class="security-title"><?php echo e($security->title); ?></span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$security->is_read): ?>
                        ...
                        <div class="security-desc"><?php echo e($security->description); ?></div>
                        <div class="security-meta">
                            🕒 <?php echo e($security->created_at->diffForHumans()); ?> | By: <?php echo e($security->user->name ?? 'System'); ?>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const labels = <?php echo json_encode(array_keys($actionChartData->toArray())); ?>;
        const actionData = <?php echo json_encode(array_values($actionChartData->toArray())); ?>;
        const activityData = <?php echo json_encode(array_values($activityChartData->toArray())); ?>;
...
<?php echo $__env->make('auditify::layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Highblossom\vendor\arpanihan\auditify\resources\views\dashboard\index.blade.php ENDPATH**/ ?>