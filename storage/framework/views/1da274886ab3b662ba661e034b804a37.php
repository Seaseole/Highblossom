...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'f4ac99e09542ff494432bc959d4fee61::admin','data' => ['title' => 'Quote Details']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Quote Details']); ?>
        ...
        <div class="flex items-center justify-between">
            <div class="space-y-1">
                ...
                <h1 class="font-headline text-3xl font-semibold text-gray-900 dark:text-white">
                    Quote #<?php echo e($quote->id); ?>

                </h1>
                <p class="text-gray-500 dark:text-gray-400">
                    Received on <?php echo e($quote->created_at->format('F j, Y \a\t g:i A')); ?>
            ...
            ?>
            <span class="px-3 py-1 rounded-full text-sm font-medium <?php echo e($statusColors[$quote->status] ?? 'bg-gray-100 text-gray-800'); ?>">
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                ...
                <div class="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm dark:border-white/10 dark:bg-[#0A0A0F]">
                    ...
                    <dl class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div class="space-y-1">
                            ...
                            <dd class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($quote->name); ?></dd>
                        </div>
                        <div class="space-y-1">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($quote->email): ?>
                            <div class="space-y-1 sm:col-span-2">
                                <dt class="text-xs font-semibold tracking-wider text-gray-500 uppercase">Email</dt>
                                <dd class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($quote->email); ?></dd>
                            </div>
                ...
                <div class="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm dark:border-white/10 dark:bg-[#0A0A0F]">
                    ...
                    <dl class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div class="space-y-1">
                            ...
                            <dd class="text-sm font-medium text-gray-900 dark:text-white">
                                <?php echo e($quote->glassType->name ?? 'Unspecified'); ?>
                        ...
                        <div class="space-y-1">
                            ...
                            <dd class="text-sm font-medium text-gray-900 dark:text-white">
                                <?php echo e($quote->serviceType->name ?? 'Unspecified'); ?>
            ...
            <div class="space-y-8">
                ...
                <div class="space-y-6 rounded-3xl border border-gray-200 bg-white p-8 shadow-sm dark:border-white/10 dark:bg-[#0A0A0F]">
                    ...
                    <form action="<?php echo e(route('admin.quotes.updateStatus', $quote)); ?>" method="POST" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        ...
                        >
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['pending', 'contacted', 'completed', 'cancelled']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <option value="<?php echo e($s); ?>" <?php echo e($quote->status === $s ? 'selected' : ''); ?>>
                ...
                <!-- Delete -->
                <form
                    action="<?php echo e(route('admin.quotes.destroy', $quote)); ?>"
                    method="POST"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Highblossom\resources\views\admin\quotes\show.blade.php ENDPATH**/ ?>