...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'f4ac99e09542ff494432bc959d4fee61::admin','data' => ['title' => 'Create SEO Configuration']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Create SEO Configuration']); ?>
    ...
    <div class="p-6">
        ...
        <div class="mb-8">
            <h1 class="font-headline text-admin-text text-3xl font-bold tracking-tight">
                Configure SEO: <span class="text-admin-accent"><?php echo e($route_label); ?></span>
            </h1>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-admin-text-muted mt-1 text-xs">
                                    <?php echo e(strlen(old('meta_title', ''))); ?>/70 characters
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="text-admin-text-muted mt-1 text-xs">
                                    <?php echo e(strlen(old('meta_description', ''))); ?>/300 characters
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="admin-glass-card rounded-3xl p-6 shadow-black/20">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                ><?php echo e(old('og_description')); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    name="twitter_title"
                                    id="twitter_title"
                                    value="<?php echo e(old('twitter_title')); ?>"
                                    maxlength="70"
                                    class="admin-form-input w-full"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    name="twitter_image"
                                    id="twitter_image"
                                    value="<?php echo e(old('twitter_image')); ?>"
                                    class="admin-form-input w-full"
                                    placeholder="https://example.com/image.jpg"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                ><?php echo e(old('twitter_description')); ?></textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    name="canonical_url"
                                    id="canonical_url"
                                    value="<?php echo e(old('canonical_url')); ?>"
                                    class="admin-form-input w-full"
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select name="changefreq" id="changefreq" class="admin-form-input w-full">
                                        <option value="always" <?php echo e(old('changefreq') === 'always' ? 'selected' : ''); ?>>
                                            Always
                                        </option>
                                        <option value="hourly" <?php echo e(old('changefreq') === 'hourly' ? 'selected' : ''); ?>>
                                            Hourly
                                        </option>
                                        <option value="daily" <?php echo e(old('changefreq') === 'daily' ? 'selected' : ''); ?>>
                                            Daily
                                        </option>
                                        <option value="weekly" <?php echo e(old('changefreq') === 'weekly' ? 'selected' : ''); ?>>
                                            Weekly
                                        </option>
                                        <option
                                            value="monthly"
                                            <?php echo e(old('changefreq', 'monthly') === 'monthly' ? 'selected' : ''); ?>

                                        >
                                            Monthly
                                        </option>
                                        <option value="yearly" <?php echo e(old('changefreq') === 'yearly' ? 'selected' : ''); ?>>
                                            Yearly
                                        </option>
                                        <option value="never" <?php echo e(old('changefreq') === 'never' ? 'selected' : ''); ?>>
                                            Never
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        min="0"
                                        max="1"
                                        value="<?php echo e(old('priority', '0.5')); ?>"
                                        class="admin-form-input w-full"
                                        placeholder="0.5"
                                    />
                                </div>
                            ...
                            <label class="bg-admin-surface-alt/50 border-admin-border-subtle hover:border-admin-accent/30 flex cursor-pointer items-center gap-3 rounded-xl border p-4 transition-colors">
                                <input
                                    ...
                                    id="no_index"
                                    value="1"
                                    <?php echo e(old('no_index') ? 'checked' : ''); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Highblossom\resources\views\admin\seo\create.blade.php ENDPATH**/ ?>