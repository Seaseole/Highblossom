...
if ($src) { ?>
        <img src="<?php echo e($src); ?>" alt="<?php echo e($alt ?? $name); ?>" class="size-full rounded-[var(--avatar-radius)] object-cover" />
        <?php } elseif ($icon) { ?>
...
<?php endif; ?>
        ...
        <?php if ($badge instanceof ComponentSlot) { ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Highblossom\resources\views\flux\avatar\index.blade.php ENDPATH**/ ?>