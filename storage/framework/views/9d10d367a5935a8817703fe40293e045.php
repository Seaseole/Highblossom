...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'f4ac99e09542ff494432bc959d4fee61::admin','data' => ['title' => 'Edit Gallery Category']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Gallery Category']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="mx-auto max-w-5xl space-y-8 py-10">
        ...
        <div class="flex items-center justify-between">
            ...
            <a
                href="<?php echo e(route('admin.gallery-categories.index')); ?>"
        ...
        <form
            method="POST"
            action="<?php echo e(route('admin.gallery-categories.update', $galleryCategory)); ?>"
                ...
                <div class="space-y-6 rounded-3xl border border-gray-200 bg-white p-8 shadow-sm dark:border-white/10 dark:bg-[#0A0A0F]">
                    <div>
                        ...
                        <input
                            type="text"
                            name="name"
                            value="<?php echo e(old('name', $galleryCategory->name)); ?>"
                            required
                            ...
                            placeholder="e.g. Architectural Aluminum"
                        />
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-6 rounded-3xl border border-gray-200 bg-white p-8 shadow-sm dark:border-white/10 dark:bg-[#0A0A0F]">
                    <div>
                        ...
                        <input
                            type="number"
                            name="sort_order"
                            value="<?php echo e(old('sort_order', $galleryCategory->sort_order)); ?>"
                            class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm transition-all outline-none focus:ring-2 focus:ring-gray-900 dark:border-white/10 dark:bg-white/5 dark:focus:ring-white"
                        />
                    </div>
                    <label class="flex cursor-pointer items-center gap-2">
                        <input
                            ...
                            name="is_active"
                            value="1"
                            <?php echo e(old('is_active', $galleryCategory->is_active) ? 'checked' : ''); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Highblossom\resources\views\admin\gallery-categories\edit.blade.php ENDPATH**/ ?>