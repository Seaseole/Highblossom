<?php $__env->startSection('title', 'Auditify Reports'); ?>
<?php $__env->startSection('header_title', 'Analytics & Reports'); ?>
...
<div class="filter-bar">
    ...
    <form action="" method="GET" id="timeframeForm">
        ...
        <select name="timeframe" id="timeframe" class="timeframe-select" onchange="document.getElementById('timeframeForm').submit();">
            <option value="7" <?php echo e($timeframe === '7' ? 'selected' : ''); ?>>Last 7 Days</option>
            <option value="30" <?php echo e($timeframe === '30' ? 'selected' : ''); ?>>Last 30 Days</option>
            <option value="90" <?php echo e($timeframe === '90' ? 'selected' : ''); ?>>Last 90 Days</option>
        </select>
    </form>
</div>
...
<div class="tab-content active" id="overview">
    <div class="mini-kpi-grid">
        <div class="mini-kpi-card" style="border-left: 4px solid var(--accent-update)">
            ...
            <span class="mini-kpi-value"><?php echo e(number_format($totalActionLogs)); ?></span>
        </div>
        <div class="mini-kpi-card" style="border-left: 4px solid #3b82f6">
            <span class="mini-kpi-label">User Activities</span>
            <span class="mini-kpi-value"><?php echo e(number_format($totalActivityLogs)); ?></span>
        </div>
        <div class="mini-kpi-card" style="border-left: 4px solid #ef4444">
            <span class="mini-kpi-label">Security Alerts</span>
            <span class="mini-kpi-value"><?php echo e(number_format($totalSecurityLogs)); ?></span>
        </div>
    </div>
    ...
    <div class="card" style="margin-bottom: 24px;">
        <h2 class="widget-title">
            ...
            System Log Activity Trends (Last <?php echo e($days); ?> Days)
        </h2>
...
<div class="tab-content" id="action">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; flex-wrap: wrap; gap: 12px;">
        ...
        <div style="display: flex; gap: 8px;">
            <a href="<?php echo e(url($prefix . '/action-logs/export/csv?start_date=' . $startDateString)); ?>" class="btn btn-secondary" style="font-size: 0.8rem; padding: 6px 12px;">
                📥 Export CSV
            </a>
            <a href="<?php echo e(url($prefix . '/action-logs/export/excel?start_date=' . $startDateString)); ?>" class="btn btn-primary" style="font-size: 0.8rem; padding: 6px 12px;">
                📊 Export Excel
            </a>
            <a href="<?php echo e(url($prefix . '/action-logs/export/pdf?start_date=' . $startDateString)); ?>" class="btn btn-danger" style="font-size: 0.8rem; padding: 6px 12px;">
                📕 Export PDF
            </a>
        </div>
    </div>
    ...
    <div class="grid-2">
        ...
        <div class="card">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($actionBreakdown)): ?>
        ...
        <div class="card">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($actionsByModule)): ?>
                <div class="chart-container">
    ...
    <div class="card">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentActionLogs->isNotEmpty()): ?>
            <div class="report-table-wrapper">
                <table class="report-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $recentActionLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr>
                                <td><strong>#<?php echo e($log->id); ?></strong></td>
                                <td><?php echo e($log->user->name ?? 'Guest User'); ?></td>
                                <td>
                                    <span class="badge badge-<?php echo e(strtolower($log->action) === 'create' ? 'create' : (strtolower($log->action) === 'update' ? 'update' : (strtolower($log->action) === 'delete' ? 'delete' : 'other'))); ?>">
                                        <?php echo e($log->action); ?>

                                    </span>
                                </td>
                                <td><code><?php echo e($log->module); ?></code></td>
                                ...
                                <td style="color: var(--text-muted); font-size: 11px;"><?php echo e($log->created_at->format('Y-m-d H:i')); ?></td>
                            </tr>
...
<div class="tab-content" id="activity">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; flex-wrap: wrap; gap: 12px;">
        ...
        <div style="display: flex; gap: 8px;">
            <a href="<?php echo e(url($prefix . '/activity-logs/export/csv?start_date=' . $startDateString)); ?>" class="btn btn-secondary" style="font-size: 0.8rem; padding: 6px 12px;">
                📥 Export CSV
            </a>
            <a href="<?php echo e(url($prefix . '/activity-logs/export/excel?start_date=' . $startDateString)); ?>" class="btn btn-primary" style="font-size: 0.8rem; padding: 6px 12px;">
                📊 Export Excel
            </a>
            <a href="<?php echo e(url($prefix . '/activity-logs/export/pdf?start_date=' . $startDateString)); ?>" class="btn btn-danger" style="font-size: 0.8rem; padding: 6px 12px;">
                📕 Export PDF
            </a>
        </div>
    </div>
    ...
    <div class="grid-2">
        ...
        <div class="card">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($topPages)): ?>
                <div class="chart-container">
    ...
    <div class="card">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentActivityLogs->isNotEmpty()): ?>
            <div class="report-table-wrapper">
                <table class="report-table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $recentActivityLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr>
                                <td><strong>#<?php echo e($log->id); ?></strong></td>
                                <td><?php echo e($log->user->name ?? 'Guest User'); ?></td>
                                <td><code><?php echo e($log->activity); ?></code></td>
                                <td style="max-width: 200px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                                    <?php echo e($log->url ? parse_url($log->url, PHP_URL_PATH) : '-'); ?>
...
<div class="tab-content" id="security">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; flex-wrap: wrap; gap: 12px;">
        ...
        <div style="display: flex; gap: 8px;">
            <a href="<?php echo e(url($prefix . '/security-logs/export/csv?start_date=' . $startDateString)); ?>" class="btn btn-secondary" style="font-size: 0.8rem; padding: 6px 12px;">
                📥 Export CSV
            </a>
            <a href="<?php echo e(url($prefix . '/security-logs/export/excel?start_date=' . $startDateString)); ?>" class="btn btn-primary" style="font-size: 0.8rem; padding: 6px 12px;">
                📊 Export Excel
            </a>
            <a href="<?php echo e(url($prefix . '/security-logs/export/pdf?start_date=' . $startDateString)); ?>" class="btn btn-danger" style="font-size: 0.8rem; padding: 6px 12px;">
                📕 Export PDF
            </a>
        </div>
    </div>
    ...
    <div class="grid-3">
        ...
        <div class="card">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($securitySeverity)): ?>
        ...
        <div class="card">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($topSecurityIps)): ?>
                <div class="chart-container" style="height: 250px;">
        ...
        <div class="card">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($resolutionStatus)): ?>
                <div class="chart-container" style="height: 250px;">
    ...
    <div class="card">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentSecurityLogs->isNotEmpty()): ?>
            <div class="report-table-wrapper">
                <table class="report-table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $recentSecurityLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr>
                                <td><strong>#<?php echo e($log->id); ?></strong></td>
                                <td>
                                    <span class="severity-badge severity-<?php echo e(strtolower($log->severity)); ?>">
                                ...
                                <td>
                                    <span class="status-badge status-<?php echo e(strtolower($log->status) === 'resolved' ? 'resolved' : 'pending'); ?>">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const trendLabels = <?php echo json_encode(array_keys($actionChartData->toArray())); ?>;
        const actionTrendData = <?php echo json_encode(array_values($actionChartData->toArray())); ?>;
        const activityTrendData = <?php echo json_encode(array_values($activityChartData->toArray())); ?>;
        const securityTrendData = <?php echo json_encode(array_values($securityChartData->toArray())); ?>;
        ...
        <?php if(!empty($actionBreakdown)): ?>
            ...
            const breakdownData = <?php echo json_encode($actionBreakdown); ?>;
        ...
        <?php if(!empty($actionsByModule)): ?>
            const moduleCtx = document.getElementById('actionsByModuleChart').getContext('2d');
            const moduleData = <?php echo json_encode($actionsByModule); ?>;
            new Chart(moduleCtx, {
                type: 'bar',
                data: {
        ...
        <?php if(!empty($topPages)): ?>
            ...
            const pagesData = <?php echo json_encode($topPages); ?>;
            new Chart(pagesCtx, {
                type: 'bar',
                data: {
        ...
        const hourlyDistribution = <?php echo json_encode($hourlyDistribution); ?>;
        new Chart(hourlyCtx, {
            type: 'bar',
            data: {
        ...
        <?php if(!empty($securitySeverity)): ?>
            const severityCtx = document.getElementById('securitySeverityChart').getContext('2d');
            const severityData = <?php echo json_encode($securitySeverity); ?>;
        ...
        <?php if(!empty($topSecurityIps)): ?>
            const ipsCtx = document.getElementById('securityIpsChart').getContext('2d');
            const ipsData = <?php echo json_encode($topSecurityIps); ?>;
            new Chart(ipsCtx, {
                type: 'bar',
                data: {
        ...
        <?php if(!empty($resolutionStatus)): ?>
            const statusCtx = document.getElementById('resolutionStatusChart').getContext('2d');
            const statusData = <?php echo json_encode($resolutionStatus); ?>;
            new Chart(statusCtx, {
                type: 'pie',
                data: {
...
<?php echo $__env->make('auditify::layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Highblossom\vendor\arpanihan\auditify\resources\views\reports\index.blade.php ENDPATH**/ ?>