<?php $__env->startSection('title', 'Activity Logs - Auditify'); ?>
<?php $__env->startSection('header_title', 'Activity Logs'); ?>

<?php $__env->startSection('header_actions'); ?>
    <a href="<?php echo e(request()->fullUrlWithQuery(['export' => 'csv']) === request()->fullUrl() ? request()->fullUrl() : url(config('auditify.route_prefix', 'auditify') . '/activity-logs/export/csv?' . http_build_query(request()->query()))); ?>" class="btn btn-secondary">
        📊 Export CSV
    </a>
    <a href="<?php echo e(request()->fullUrlWithQuery(['export' => 'excel']) === request()->fullUrl() ? request()->fullUrl() : url(config('auditify.route_prefix', 'auditify') . '/activity-logs/export/excel?' . http_build_query(request()->query()))); ?>" class="btn btn-primary">
        📈 Export Excel
    </a>
...
<div class="card" style="margin-bottom: 32px;">
    <form method="GET" action="<?php echo e(url(config('auditify.route_prefix', 'auditify') . '/activity-logs')); ?>">
        <div class="filter-panel">
            <div class="form-group">
                <label for="search">Keywords / URL</label>
                <input type="text" name="search" id="search" value="<?php echo e(request('search')); ?>" placeholder="Search details or url..." class="form-control">
            </div>
            ...
            <div class="form-group">
                ...
                <select name="activity" id="activity" class="form-control">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $act): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <option value="<?php echo e($act); ?>" <?php echo e(request('activity') === $act ? 'selected' : ''); ?>><?php echo e($act); ?></option>
            ...
            <div class="form-group">
                ...
                <input type="text" name="ip_address" id="ip_address" value="<?php echo e(request('ip_address')); ?>" placeholder="e.g. 127.0.0.1" class="form-control">
            </div>
            ...
            <div class="filter-actions">
                <a href="<?php echo e(url(config('auditify.route_prefix', 'auditify') . '/activity-logs')); ?>" class="btn btn-secondary">Clear Filters</a>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <tr>
                    ...
                    <td style="white-space: nowrap;">
                        ...
                        ?>
                        <span class="activity-badge <?php echo e($badgeClass); ?>" title="<?php echo e($log->activity); ?>"><?php echo e($log->activity); ?></span>
                    </td>
                    <td style="font-family: var(--font-mono); font-size: 12px; color: var(--text-secondary); max-width: 180px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="<?php echo e($log->url); ?>">
                        <?php echo e($log->url ?? '-'); ?>
                    ...
                    <td style="color: var(--text-muted); font-size: 11px; max-width: 120px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="<?php echo e($log->user_agent); ?>">
                    ...
                    <td style="text-align: center; white-space: nowrap;">
                        <a href="<?php echo e(url(config('auditify.route_prefix', 'auditify') . '/activity-logs/' . $log->id)); ?>" class="btn btn-secondary" style="padding: 6px 12px; font-size: 12px; border-radius: 6px;">
                            Details
                        </a>
                    </td>
                </tr>
...
<?php echo $__env->make('auditify::layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Highblossom\vendor\arpanihan\auditify\src/../resources/views/activity-logs/index.blade.php ENDPATH**/ ?>