...
<div class="rounded-lg border border-border bg-card/50 p-3 mb-3">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm">
        <div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($anomaly->kind === 'short'): ?>
        ...
        <div>
            ...
            <p class="text-sm"><?php echo e($deltaText()); ?></p>
        </div>
        <div>
            <span class="text-[10px] font-medium text-muted-foreground uppercase">Baseline</span>
            <p class="text-sm tabular-nums">p50 <?php echo e(number_format($anomaly->baseline_p50_ms)); ?> ms · p95 <?php echo e(number_format($anomaly->baseline_p95_ms)); ?> ms · n=<?php echo e(number_format($anomaly->samples_count)); ?></p>
        </div>
    </div>
</div>

<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job === null): ?>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\laragon\www\Highblossom\vendor\romalytar\yammi-jobs-monitoring-laravel\resources\views\partials\anomaly-detail.blade.php ENDPATH**/ ?>