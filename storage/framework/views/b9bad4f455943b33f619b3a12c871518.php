<div
    class="space-y-4"
    wire:ignore.self
    <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'block-builder-'.e($name).''; ?>wire:key="block-builder-<?php echo e($name); ?>"
    x-data="blockBuilder({
    initialBlocks: <?php echo e(Js::from($blocks ?? [])); ?>,
    availableBlockTypes: <?php echo e(Js::from($availableBlockTypes ?? [])); ?>
...
<?php /**PATH C:\laragon\www\Highblossom\resources\views\livewire\block-builder.blade.php ENDPATH**/ ?>