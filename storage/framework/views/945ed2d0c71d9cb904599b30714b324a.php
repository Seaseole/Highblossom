<?php $__env->startSection('title', 'Security Logs - Auditify'); ?>
<?php $__env->startSection('header_title', 'Security Logs'); ?>

<?php $__env->startSection('header_actions'); ?>
    <a href="<?php echo e(request()->fullUrlWithQuery(['export' => 'csv']) === request()->fullUrl() ? request()->fullUrl() : url(config('auditify.route_prefix', 'auditify') . '/security-logs/export/csv?' . http_build_query(request()->query()))); ?>" class="btn btn-secondary">
        📊 Export CSV
    </a>
    <a href="<?php echo e(request()->fullUrlWithQuery(['export' => 'excel']) === request()->fullUrl() ? request()->fullUrl() : url(config('auditify.route_prefix', 'auditify') . '/security-logs/export/excel?' . http_build_query(request()->query()))); ?>" class="btn btn-primary">
        📈 Export Excel
    </a>
...
<div class="card" style="margin-bottom: 32px;">
    <form method="GET" action="<?php echo e(url(config('auditify.route_prefix', 'auditify') . '/security-logs')); ?>">
        <div class="filter-panel">
            <div class="form-group">
                <label for="search">Keywords</label>
                <input type="text" name="search" id="search" value="<?php echo e(request('search')); ?>" placeholder="Search breaches..." class="form-control">
            </div>
            ...
            <div class="form-group">
                ...
                <select name="severity" id="severity" class="form-control">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['low', 'medium', 'high', 'critical']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <option value="<?php echo e($sev); ?>" <?php echo e(request('severity') === $sev ? 'selected' : ''); ?>><?php echo e(strtoupper($sev)); ?></option>
            ...
            <div class="form-group">
                ...
                <select name="is_read" id="is_read" class="form-control">
                    ...
                    <option value="0" <?php echo e(request('is_read') === '0' ? 'selected' : ''); ?>>Unread</option>
                    <option value="1" <?php echo e(request('is_read') === '1' ? 'selected' : ''); ?>>Read</option>
                </select>
            </div>
            ...
            <div class="filter-actions">
                <a href="<?php echo e(url(config('auditify.route_prefix', 'auditify') . '/security-logs')); ?>" class="btn btn-secondary">Clear Filters</a>
    ...
    <table class="audit-table">
        ...
        <tbody>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <tr class="<?php echo e(!$log->is_read ? 'row-unread' : ''); ?>">
                    ...
                    <td style="white-space: nowrap;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($log->user): ?>
                            <div class="user-pill">
                                <span style="color: var(--text-primary);"><?php echo e($log->user->name); ?></span>
                            </div>
                        <?php else: ?>
                    ...
                    <td style="white-space: nowrap;">
                        <span class="sev-badge sev-<?php echo e($log->severity); ?>"><?php echo e($log->severity); ?></span>
                    </td>
                    <td style="color: var(--card-text-highlight); white-space: nowrap;"><?php echo e($log->title); ?></td>
                    <td style="color: var(--text-secondary);"><?php echo e($log->description); ?></td>
                    <td style="font-family: var(--font-mono); color: var(--text-primary); white-space: nowrap;"><?php echo e($log->ip_address ?? '-'); ?></td>
                    ...
                    <td style="text-align: center;">
                        <div style="display: flex; gap: 8px; justify-content: center; align-items: center;">
                            <a href="<?php echo e(url(config('auditify.route_prefix', 'auditify') . '/security-logs/' . $log->id)); ?>" class="btn btn-secondary" style="padding: 6px 12px; font-size: 12px; border-radius: 6px;">
                                Details
                            </a>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$log->is_read): ?>
                                <form method="POST" action="<?php echo e(url(config('auditify.route_prefix', 'auditify') . '/security-logs/' . $log->id . '/read')); ?>" style="margin: 0;">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('auditify::layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Highblossom\vendor\arpanihan\auditify\resources\views\security-logs\index.blade.php ENDPATH**/ ?>