<?php $__env->startSection('title', 'Activity Log #' . $log->id . ' Details'); ?>
<?php $__env->startSection('header_title', 'Activity Log Details'); ?>

<?php $__env->startSection('header_actions'); ?>
    <a href="<?php echo e(url(config('auditify.route_prefix', 'auditify') . '/activity-logs')); ?>" class="btn btn-secondary">
        &larr; Back to Logs
    </a>
...
<div class="detail-grid">
    ...
    <div class="card" style="padding: 24px;">
        ...
        <div id="tab-details" class="tab-panel active">
            <div style="margin-bottom: 24px;">
                ...
                ?>
                <span class="activity-badge <?php echo e($badgeClass); ?>" style="font-size: 14px; padding: 6px 12px; border-radius: 8px;">
                    <?php echo e($log->activity); ?>

                </span>
            </div>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($log->properties)): ?>
                <div>
                    ...
                    <pre class="code-terminal" style="background-color: var(--table-header-bg); border-color: var(--border-color); color: var(--text-primary);"><code><?php echo json_encode($log->properties, JSON_PRETTY_PRINT); ?></code></pre>
                </div>
            <?php else: ?>
  ...
  "activity": "<?php echo e($log->activity); ?>",
  "url": "<?php echo e($log->url); ?>",
  "properties": <?php echo $log->properties ? json_encode($log->properties, JSON_PRETTY_PRINT) : 'null'; ?>,
...
<?php echo $__env->make('auditify::layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Highblossom\vendor\arpanihan\auditify\src/../resources/views/activity-logs/show.blade.php ENDPATH**/ ?>