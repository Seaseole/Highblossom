...
<?php endif; ?>
    ...
    <?php } elseif ($icon) { ?>
    <div <?php echo e($icon->attributes->class($iconWrapperClasses)); ?>><?php echo e($icon); ?></div>
    <?php } ?>
...
<?php endif; ?>
        ...
        <?php if ($actions) { ?>
        <div
            <?php echo e($actions->attributes->class([
    ...
    <?php if ($controls) { ?>
    <div <?php echo e($controls->attributes->class($inline ? 'ps-2 m-[-2px]' : 'ps-2')); ?>><?php echo e($controls); ?></div>
    <?php } ?>
</div>
<?php /**PATH C:\laragon\www\Highblossom\resources\views\flux\callout\index.blade.php ENDPATH**/ ?>