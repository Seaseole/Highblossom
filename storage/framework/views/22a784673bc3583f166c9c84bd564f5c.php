...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'f4ac99e09542ff494432bc959d4fee61::admin','data' => ['title' => 'Edit Staff Member']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Staff Member']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="mx-auto max-w-xl space-y-8 py-10">
        ...
        <div class="flex items-center justify-between">
            <div class="space-y-1">
                <h1 class="font-headline text-3xl font-semibold text-gray-900 dark:text-white">Edit Staff Member</h1>
        ...
        <form
            action="<?php echo e(route('admin.staff.update', $staff)); ?>"
            method="POST"
            enctype="multipart/form-data"
            class="space-y-6 rounded-3xl border border-gray-200 bg-white p-8 shadow-sm dark:border-white/10 dark:bg-[#0A0A0F]"
            x-data="{ imagePreview: '<?php echo e($staff->photo_url); ?>', handleFileSelect(event) { const file = event.target.files[0]; if (file) this.imagePreview = URL.createObjectURL(file); } }"
        >
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input
                        type="text"
                        name="role"
                        value="<?php echo e(old('role', $staff->role)); ?>"
                        required
                        class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm transition-all outline-none focus:ring-2 focus:ring-gray-900 dark:border-white/10 dark:bg-white/5 dark:focus:ring-white"
                    />
                </div>
                <div>
                    ...
                    <textarea
                        ...
                        rows="4"
                        class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm transition-all outline-none focus:ring-2 focus:ring-gray-900 dark:border-white/10 dark:bg-white/5 dark:focus:ring-white"
                    ><?php echo e(old('bio', $staff->bio)); ?></textarea>
                </div>
                <div class="space-y-4">
                    ...
                    <p class="text-center text-xs text-gray-500 dark:text-gray-400">Click the photo to replace.</p>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Highblossom\resources\views\admin\staff\edit.blade.php ENDPATH**/ ?>