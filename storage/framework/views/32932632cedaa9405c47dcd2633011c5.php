...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'f4ac99e09542ff494432bc959d4fee61::admin','data' => ['title' => 'Gallery']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
    ...
    <div class="mx-auto max-w-7xl space-y-8 py-10">
        ...
        <div class="flex flex-col justify-between gap-6 md:flex-row md:items-center">
            ...
            <div class="flex items-center gap-3">
                <a
                    href="<?php echo e(route('admin.gallery-settings.index')); ?>"
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/10">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="transition-colors duration-200 hover:bg-gray-50 dark:hover:bg-white/5">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($item->title); ?></div>
                            ...
                            <td class="px-6 py-4">
                                <span class="text-sm text-gray-600 dark:text-gray-300"><?php echo e($item->location_address ?? '-'); ?></span>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex gap-2">
                                    ...
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <span class="px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($item->is_active ? 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400' : 'bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-400'); ?>">
                            ...
                            <td class="px-6 py-4 text-right">
                                <a
                                    href="<?php echo e(route('admin.gallery.edit', $item)); ?>"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Highblossom\resources\views\admin\gallery\index.blade.php ENDPATH**/ ?>