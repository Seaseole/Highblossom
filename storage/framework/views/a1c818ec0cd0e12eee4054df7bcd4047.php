...
<head>
    ...
    <title>Confirm Password - <?php echo e(config('app.name')); ?></title>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <p class="mt-2 px-1 text-sm font-medium text-[#DC2626]"><?php echo e($message); ?></p>
                            <?php unset($message);
...
<?php /**PATH C:\laragon\www\Highblossom\resources\views\auth\confirm-password.blade.php ENDPATH**/ ?>