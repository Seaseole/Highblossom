...
<head>
    ...
    <title>New Quote Request - <?php echo e($companyName); ?></title>
    <style type="text/css">
        /* Basic Reset */
                ...
                <table width="600" border="0" cellspacing="0" cellpadding="0" class="container" style="width: 600px; background-color: #ffffff; border: 1px solid #E5E7EB; border-radius: 4px; overflow: hidden;">
                    ...
                    <tr>
                        <td bgcolor="#111827" style="padding: 40px 40px; border-bottom: 4px solid #DC2626;">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td>
                                        <h1 style="color: #ffffff; font-size: 20px; font-weight: 700; margin: 0; text-transform: uppercase; letter-spacing: 2px;"><?php echo e($companyName); ?></h1>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                                    ...
                                    <td style="padding-top: 16px;">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td style="font-size: 14px; color: #111827; font-weight: 500; padding-bottom: 8px;"><?php echo e($quote->name); ?></td>
                                            </tr>
                                            <tr>
                                                <td width="100" style="font-size: 12px; color: #6B7280; font-weight: 600; padding-bottom: 8px;">PHONE</td>
                                                <td style="font-size: 14px; color: #111827; font-weight: 500; padding-bottom: 8px;"><?php echo e($quote->phone); ?></td>
                                            </tr>
                                            <tr>
                                                <td width="100" style="font-size: 12px; color: #6B7280; font-weight: 600; padding-bottom: 8px;">EMAIL</td>
                                                <td style="font-size: 14px; color: #111827; font-weight: 500; padding-bottom: 8px;"><?php echo e($quote->email ?? 'N/A'); ?></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="50%" class="stack" valign="top">
                                                    ...
                                                    <p style="font-size: 15px; color: #111827; margin: 0; font-weight: 700;"><?php echo e($quote->make_model ?? 'Not specified'); ?></p>
                                                </td>
                                                <td width="50%" class="stack mobile-padding" valign="top">
                                                    ...
                                                    <p style="font-size: 15px; color: #111827; margin: 0; font-weight: 700;"><?php echo e($quote->year ?? '----'); ?> / <?php echo e($quote->reg_number ?? '----'); ?></p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td style="padding-bottom: 16px;">
                                                    ...
                                                    <p style="font-size: 14px; color: #111827; margin: 0; font-weight: 600;"><?php echo e($quote->full_glass_description); ?></p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-bottom: 16px;">
                                                    <p style="font-size: 12px; color: #6B7280; margin: 0 0 4px; font-weight: 600;">SERVICE TYPE</p>
                                                    <p style="font-size: 14px; color: #111827; margin: 0; font-weight: 600;"><?php echo e($quote->serviceType?->name ?? 'N/A'); ?></p>
                                                </td>
                                            </tr>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($quote->mobile_service): ?>
                                            <tr>
                                                <td style="padding-bottom: 16px;">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($quote->message): ?>
                            <!-- User Message -->
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 32px;">
                                <tr>
                                    <td style="background-color: #F3F4F6; padding: 24px; border-radius: 4px; border-left: 4px solid #9CA3AF;">
                                        ...
                                        <p style="font-size: 14px; color: #374151; margin: 0; font-style: italic; line-height: 1.5;">"<?php echo e($quote->message); ?>"</p>
                                    </td>
                                </tr>
                            </table>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <!-- Reference Image -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($quote->image_path): ?>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 40px;">
                                <tr>
                                    <td align="center">
                                        <a href="<?php echo e(url('storage/' . $quote->image_path)); ?>" target="_blank" style="display: block; padding: 12px 24px; border: 2px solid #111827; color: #111827; font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; border-radius: 0;">View Reference Image</a>
                                    </td>
                                </tr>
                            </table>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center" bgcolor="#DC2626" style="border-radius: 4px;">
                                        <a href="<?php echo e(route('admin.quotes.show', $quote->id)); ?>" target="_blank" style="display: block; padding: 18px 24px; color: #ffffff; font-size: 14px; font-weight: 700; text-transform: uppercase; letter-spacing: 2px;">Access Admin Portal</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td bgcolor="#F9FAFB" style="padding: 32px 40px; border-top: 1px solid #E5E7EB; text-align: center;">
                            <p style="color: #9CA3AF; font-size: 11px; margin: 0; text-transform: uppercase; letter-spacing: 1px;">&copy; <?php echo e(date('Y')); ?> <?php echo e($companyName); ?> PTY LTD. All rights reserved.</p>
...
<?php /**PATH C:\laragon\www\Highblossom\resources\views\emails\quotes\submitted-admin.blade.php ENDPATH**/ ?>