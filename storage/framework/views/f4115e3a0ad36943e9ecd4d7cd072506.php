...
<head>
    ...
    <title>Quote Request Received - <?php echo e($companyName); ?></title>
    <style type="text/css">
        /* Basic Reset */
                ...
                <table width="600" border="0" cellspacing="0" cellpadding="0" class="container" style="width: 600px; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04);">
                    ...
                    <tr>
                        <td align="center" bgcolor="#111827" style="padding: 60px 40px; border-bottom: 6px solid #DC2626;">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center">
                                        <h1 style="color: #ffffff; font-size: 24px; font-weight: 700; margin: 0; text-transform: uppercase; letter-spacing: 4px;"><?php echo e($companyName); ?></h1>
                    ...
                    <tr>
                        <td style="padding: 40px 40px 20px;">
                            <p style="font-size: 16px; color: #374151; margin: 0; line-height: 1.6;">Dear <strong><?php echo e($quote->name); ?></strong>,</p>
                            <p style="font-size: 16px; color: #4B5563; margin: 16px 0 0; line-height: 1.6;">Thank you for choosing <?php echo e($companyName); ?>. We have received your architectural glass request and our specialists are currently reviewing the specifications. We aim to provide a detailed response within 24 hours.</p>
                        </td>
                    </tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 24px;">
                                            <tr>
                                                <td style="padding-bottom: 12px;">
                                                    ...
                                                    <p style="font-size: 14px; color: #111827; margin: 0; font-weight: 600;"><?php echo e($quote->make_model ?? ucfirst($quote->vehicle_type)); ?> <?php echo e($quote->year ? '(' . $quote->year . ')' : ''); ?></p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-bottom: 12px;">
                                                    <p style="font-size: 11px; color: #9CA3AF; margin: 0 0 4px; font-weight: 600;">SERVICE</p>
                                                    <p style="font-size: 14px; color: #111827; margin: 0; font-weight: 600;"><?php echo e($quote->serviceType?->name ?? 'Architectural Glass Service'); ?></p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-top: 1px solid #E5E7EB; padding-top: 20px;">
                                            <tr>
                                                <td width="50%" class="stack" valign="top">
                                                    ...
                                                    <p style="font-size: 13px; color: #111827; margin: 0; font-weight: 700;">#<?php echo e($quote->id); ?></p>
                                                </td>
                    ...
                    <tr>
                        <td style="padding: 20px 40px;">
                            ...
                            <p style="font-size: 14px; color: #4B5563; margin: 0; font-style: italic; line-height: 1.5; border-left: 2px solid #E5E7EB; padding-left: 16px;">"<?php echo e($quote->message); ?>"</p>
                        </td>
                    </tr>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border: 1px solid #E5E7EB; border-radius: 4px;">
                                <tr>
                                    <td style="padding: 24px; text-align: center;">
                                        ...
                                        <a href="tel:+267<?php echo e($primaryPhone ?? '+2673117480'); ?>" style="font-size: 15px; color: #111827; margin: 0; font-weight: 700;"><?php echo e($primaryPhone ?? '+267 311 7480'); ?></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td bgcolor="#F9FAFB" style="padding: 40px; border-top: 1px solid #E5E7EB; text-align: center;">
                            <p style="color: #111827; font-size: 12px; font-weight: 700; margin: 0; text-transform: uppercase; letter-spacing: 1px;"><?php echo e($companyName); ?></p>
                            ...
                            <div style="margin: 24px 0;">
                                <table align="center" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td style="padding: 0 10px; color: #9CA3AF; font-size: 10px;"><?php echo e(date('Y')); ?> &copy; All Rights Reserved</td>
                                    </tr>
                                </table>
                            </div>
                        </td>
...
<?php /**PATH C:\laragon\www\Highblossom\resources\views\emails\quotes\submitted-customer.blade.php ENDPATH**/ ?>