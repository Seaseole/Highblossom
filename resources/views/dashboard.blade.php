<x-layouts::admin title="Dashboard">
    <div class="mb-8">
        <h1 class="text-4xl font-bold text-[#39393c] mb-2">Dashboard</h1>
        <p class="text-zinc-600">Welcome back. Here's what's happening today.</p>
    </div>
        ...
        <div class="bg-white/5 border border-zinc-200/10 p-1.5 rounded-[1.5rem]">
            <div class="bg-white rounded-[calc(1.5rem-0.375rem)] p-6 shadow-sm">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-xs font-semibold text-zinc-400 uppercase tracking-wider">Bookings</span>
                </div>
                <h3 class="text-3xl font-bold text-[#39393c] mb-1">{{ $totalBookings }}</h3>
                <p class="text-zinc-500 text-sm">Total bookings</p>
            </div>
        </div>
        ...
        <div class="bg-white/5 border border-zinc-200/10 p-1.5 rounded-[1.5rem]">
            <div class="bg-white rounded-[calc(1.5rem-0.375rem)] p-6 shadow-sm">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-xs font-semibold text-zinc-400 uppercase tracking-wider">Inspections</span>
                </div>
                <h3 class="text-3xl font-bold text-[#39393c] mb-1">{{ $pendingInspections }}</h3>
                <p class="text-zinc-500 text-sm">Pending inspections</p>
            </div>
        </div>
        ...
        <div class="bg-white/5 border border-zinc-200/10 p-1.5 rounded-[1.5rem]">
            <div class="bg-white rounded-[calc(1.5rem-0.375rem)] p-6 shadow-sm">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-xs font-semibold text-zinc-400 uppercase tracking-wider">Users</span>
                </div>
                <h3 class="text-3xl font-bold text-[#39393c] mb-1">{{ $totalUsers }}</h3>
                <p class="text-zinc-500 text-sm">Active users</p>
            </div>
        </div>
        ...
        <div class="bg-white/5 border border-zinc-200/10 p-1.5 rounded-[1.5rem]">
            <div class="bg-white rounded-[calc(1.5rem-0.375rem)] p-6 shadow-sm">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-xs font-semibold text-zinc-400 uppercase tracking-wider">Quotes</span>
                </div>
                <div class="space-y-3">
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-zinc-600">Pending</span>
                        <span class="text-lg font-semibold text-[#39393c]">{{ $pendingQuotes }}</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-zinc-600">Contacted</span>
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-zinc-600">Cancelled</span>
    ...
    <div class="bg-white/5 border border-zinc-200/10 p-1.5 rounded-[1.5rem]">
        <div class="bg-white rounded-[calc(1.5rem-0.375rem)] p-8 shadow-sm">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-xl font-bold text-[#39393c]">Recent Activity</h2>
            ...
            <div class="text-center py-12">
                ...
                <p class="text-zinc-400 text-sm mt-1">Activity will appear here as you use the system</p>
            </div>
        </div>
    </div>
</x-layouts::admin>
