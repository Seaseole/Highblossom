        ...
        <div class="flex items-center justify-center p-8 lg:p-12">
            <div class="w-full max-w-md">
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl shadow-2xl shadow-[#0A0A0F]/50 p-8">
                    <h2 class="text-2xl font-bold text-[#FAFAFA] mb-2 font-headline">Confirm Password</h2>
                    <p class="text-[#A1A1AA] mb-8">This is a secure area. Please confirm your password.</p>
