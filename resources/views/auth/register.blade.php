                    ...
                    <form method="POST" action="{{ route('register') }}" class="space-y-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="animate-fade-in-up delay-400">
                                <label for="password" class="block text-xs font-bold text-[#71717A] uppercase tracking-widest mb-2 px-1">Password</label>
                                <input
                                    id="password"
                                    type="password"
                                    name="password"
                            ...
                            <div class="animate-fade-in-up delay-400">
                                <label for="password_confirmation" class="block text-xs font-bold text-[#71717A] uppercase tracking-widest mb-2 px-1">Confirm</label>
                                <input
