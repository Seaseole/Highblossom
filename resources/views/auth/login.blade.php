        ...
        <div class="flex items-center justify-center p-8 lg:p-12">
            <div class="w-full max-w-md">
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl shadow-2xl shadow-[#0A0A0F]/50 p-8">
                    <h2 class="text-2xl font-bold text-[#FAFAFA] mb-2 font-headline">{{ __('auth.login.heading') }}</h2>
                    <p class="text-[#A1A1AA] mb-8">{{ __('auth.login.subheading') }}</p>

                    <form method="POST" action="{{ route('login') }}" class="space-y-5">
                        @csrf

                        <div>
                            <label for="email" class="block text-sm font-medium text-[#A1A1AA] mb-2">{{ __('auth.login.email_label') }}</label>
                            <input
                                id="email"
                                type="email"
                                name="email"
                        ...
                        <div>
                            <label for="password" class="block text-sm font-medium text-[#A1A1AA] mb-2">{{ __('auth.login.password_label') }}</label>
                            <input
                                id="password"
                                type="password"
                                name="password"
