    ...
    <section class="relative bg-[#0A0A0F] pt-32 pb-20">
        <div class="mx-auto max-w-[1400px] px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center">
                ...
                <p class="text-lg leading-relaxed text-[#A1A1AA]">{{ __('quote.description') }}</p>
            </div>
        </div>
    </section>
                    ...
                    <div class="glass-card rounded-2xl p-8 md:p-12">
                        ...
                        >
                            ...
                            <input
                                ...
                                value="{{ session()->get('quote_token', md5(uniqid())) }}"
                            />
                                ...
                                <div class="mb-6 flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 class="font-headline text-xl font-bold text-[#FAFAFA]">
                                            {{ __('quote.your_information') }}
                                        </h3>
                                        <p class="text-sm text-[#71717A]">{{ __('quote.your_info_description') }}</p>
                                    </div>
                                </div>
                                <div class="grid gap-6 md:grid-cols-2">
                                    <div>
                                        <label for="name" class="mb-2 block text-sm font-medium text-[#A1A1AA]"
                                            >{{ __('quote.full_name_label') }} <span style="color: red">*</span></label>
                                        <input
                                            type="text"
                                            id="name"
                                            name="name"
                                        ...
                                        />
                                        @error('name')
                                            <p x-show="showErrors" class="mt-1 text-xs text-red-500">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div>
                                        <label for="phone" class="mb-2 block text-sm font-medium text-[#A1A1AA]"
                                            >{{ __('quote.phone_number_label') }}
                            ...
                            <div class="border-t border-white/5 pt-10">
                                <div class="mb-6 flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 class="font-headline text-xl font-bold text-[#FAFAFA]">
                                            {{ __('quote.vehicle_details') }}
                                        </h3>
                                        <p class="text-sm text-[#71717A]">{{ __('quote.vehicle_info_description') }}</p>
                                    </div>
                                </div>
                                <div class="grid gap-6 md:grid-cols-2">
                                    <div>
                                        <label for="vehicle_type" class="mb-2 block text-sm font-medium text-[#A1A1AA]"
                                            >{{ __('quote.vehicle_type') }} <span style="color: red">*</span></label>
                                        <select
                                            id="vehicle_type"
                                            name="vehicle_type"
                                            required
                                            class="form-input-premium @error('vehicle_type') border-red-500 @enderror"
                                        >
                                    ...
                                    <div>
                                        <label
                                            for="reg_number"
                                            class="mb-2 block text-sm font-medium text-[#A1A1AA]"
                                        >{{ __('quote.registration_number') }}</label>
                                        <input
                                            type="text"
                                            id="reg_number"
                                            name="reg_number"
                            ...
                            <div class="border-t border-white/5 pt-10">
                                <div class="mb-6 flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 class="font-headline text-xl font-bold text-[#FAFAFA]">
                                            {{ __('quote.service_required') }}
                                        </h3>
                                        <p class="text-sm text-[#71717A]">{{ __('quote.service_description') }}</p>
                                    </div>
                                </div>
                                ...
                                >
                                    <div>
                                        <label for="glass_type_id" class="mb-2 block text-sm font-medium text-[#A1A1AA]"
                                            >{{ __('quote.glass_type') }} <span style="color: red">*</span></label>
                                        <select
                                            id="glass_type_id"
                                            name="glass_type_id"
                                            required
                                ...
                                <div class="grid gap-6 md:grid-cols-1">
                                    <div>
                                        <label
                                            for="service_type_id"
                                            class="mb-2 block text-sm font-medium text-[#A1A1AA]"
                                        >{{ __('quote.service_type') }} <span style="color: red">*</span></label>
                                        <select
                                            id="service_type_id"
                                            name="service_type_id"
                                            required
                                            class="form-input-premium @error('service_type_id') border-red-500 @enderror"
                                        >
                            ...
                            <div class="border-t border-white/5 pt-10">
                                <div class="mb-6 flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 class="font-headline text-xl font-bold text-[#FAFAFA]">
                                            {{ __('quote.additional_info') }}
                                        </h3>
                                        <p class="text-sm text-[#71717A]">
                                            {{ __('quote.additional_info_description') }}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="mb-6">
                                    <h3 class="mb-2 text-lg font-medium text-[#FAFAFA]">
                                        {{ __('quote.visual_assessment') }}
                                    </h3>
                                    <p class="mb-4 text-sm text-[#71717A]">{{ __('quote.upload_description') }}</p>
                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-32 space-y-6">
                        ...
                        <div class="glass-card rounded-2xl p-6">
                            ...
                            <ul class="space-y-3">
                                <li class="flex items-start gap-3">
                                    ...
                                    <span class="text-sm text-[#A1A1AA]">{{ __('quote.benefit_1') }}</span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="mt-0.5 h-5 w-5 flex-shrink-0 text-[#DC2626]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="text-sm text-[#A1A1AA]">{{ __('quote.benefit_2') }}</span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="mt-0.5 h-5 w-5 flex-shrink-0 text-[#DC2626]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="text-sm text-[#A1A1AA]">{{ __('quote.benefit_3') }}</span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="mt-0.5 h-5 w-5 flex-shrink-0 text-[#DC2626]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="text-sm text-[#A1A1AA]">{{ __('quote.benefit_4') }}</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        @if ($primaryPhone)
                            <div class="glass-card rounded-2xl p-6">
                                <h3 class="font-headline mb-4 text-lg font-bold text-[#FAFAFA]">
                                    {{ __('quote.prefer_to_call') }}
                                </h3>
                                <p class="mb-4 text-sm text-[#A1A1AA]">{{ __('quote.call_description') }}</p>
                                <a
                        ...
                        <div class="rounded-2xl border border-[#DC2626]/30 bg-[#DC2626]/10 p-6">
                            <div class="mb-3 flex items-center gap-2">
                                ...
                                <span class="text-sm font-semibold text-[#DC2626] uppercase">{{ __('quote.emergency_24_7') }}</span>
                            </div>
                            <p class="mb-4 text-sm text-[#A1A1AA]">{{ __('quote.emergency_description') }}</p>
                            @if ($primaryPhone)
                                <a
                                    href="tel:{{ str_replace([' ', '-', '(', ')'], '', $primaryPhone) }}"
