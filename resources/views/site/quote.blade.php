                        ...
                        <form action="{{ route('quote.submit') }}" method="POST" enctype="multipart/form-data" class="space-y-10"
                            ...
                            <div class="pt-10 border-t border-white/5">
                                <button type="submit"
                                    ...
                                    <span x-show="!isSubmitting && !isUploading" x-cloak>{{ __('quote.submit_quote') }}</span>
                                    ...
                                    <svg x-show="!isSubmitting && !isUploading" x-cloak class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
