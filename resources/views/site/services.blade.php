    ...
    <section class="py-24 lg:py-32 bg-[#0A0A0F]">
        <div class="max-w-[1400px] mx-auto px-6 lg:px-8">
            ...
            <div class="text-center mt-16">
                <a href="{{ route('services', ['page' => $services->currentPage() + 1]) }}" class="btn-glass text-lg px-8 py-4">
            ...
            <div class="glass-card rounded-3xl p-12 lg:p-16 text-center relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        @if ($primaryPhone)
                        <a href="tel:{{ str_replace([' ', '-', '(', ')'], '', $primaryPhone) }}" class="btn-glass text-lg px-8 py-4">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
