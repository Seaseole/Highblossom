    ...
    <header class="relative pt-20 pb-16 overflow-hidden bg-surface">
        <div class="max-w-7xl mx-auto px-8 relative z-10">
            ...
            <p class="text-on-surface-variant text-lg leading-relaxed">
                {{ $this->posts->total() }} {{ __('posts tagged with') }} #{{ $tag->name }}
            </p>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-8">
            @if($this->posts->isEmpty())
                <div class="glass-card p-16 rounded-2xl text-center border border-white/30 shadow-[0_8px_32px_-12px_rgba(0,0,0,0.15)] max-w-2xl mx-auto">
                    <span class="material-symbols-outlined text-6xl text-surface-container-highest mb-6 block">label_off</span>
                    <h3 class="text-2xl font-headline font-semibold text-on-surface mb-3">{{ __('No posts with this tag') }}</h3>
