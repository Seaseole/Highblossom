<x-layouts::admin title="Create Service">
    <div class="p-8 max-w-5xl mx-auto space-y-10">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div class="space-y-1">
                <div class="flex items-center gap-3 text-admin-text-muted mb-2">
                    ...
                    <span class="text-[10px] font-bold uppercase tracking-[0.2em] font-body">Services / New</span>
                </div>
        ...
        <form method="POST" action="{{ route('admin.services.store') }}" class="grid grid-cols-1 lg:grid-cols-3 gap-8" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 gap-6">
                            <div class="space-y-2">
                                ...
                                <input type="text" name="title" id="title" required class="admin-form-input font-headline text-lg font-bold tracking-tight" placeholder="e.g. Structural Glass Balustrades">
                                @error('title')
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea name="short_description" id="short_description" rows="2" required class="admin-form-input font-body text-sm leading-relaxed resize-none" placeholder="A high-level summary for service cards...">{{ old('short_description') }}</textarea>
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea name="full_description" id="full_description" rows="6" class="admin-form-input font-body text-sm leading-relaxed resize-none" placeholder="Full technical details and service scope...">{{ old('full_description') }}</textarea>
            ...
            <div class="space-y-6">
                <div class="admin-glass-card p-6 rounded-3xl shadow-xl shadow-black/10 space-y-6">
                    <div class="space-y-4">
                        ...
                        <div class="space-y-4">
                            <div id="image-preview-container" class="space-y-4"></div>
                            ...
                            <div class="relative group/upload">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="admin-form-input flex flex-col items-center justify-center py-8 border-dashed border-2 border-admin-border-subtle group-hover/upload:border-admin-accent/30 transition-colors">
                                        ...
                                        <span class="text-[10px] font-bold text-admin-text uppercase tracking-widest">Upload Image</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <input type="url" name="image_url" id="image_url" class="admin-form-input pl-10 text-xs font-mono" placeholder="External URL...">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4 pt-6 border-t border-admin-border-subtle">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div class="space-y-2">
                                ...
                                <input type="number" name="sort_order" id="sort_order" class="admin-form-input text-sm" placeholder="0">
                            </div>
                ...
                <div class="flex flex-col gap-3">
                    <button type="submit" class="admin-action-btn admin-action-btn-primary w-full justify-center py-4 shadow-lg shadow-admin-accent/20 focus:ring-admin-accent">
                        <span class="text-xs font-bold uppercase tracking-[0.2em]">Publish Service</span>
                    </button>
