        ...
        <form method="POST" action="{{ route('admin.users.store') }}" class="max-w-2xl">
            ...
            <div class="bg-admin-surface-alt border border-admin-border rounded-xl p-6 space-y-4">
                <div>
                    ...
                    <input type="text" name="name" id="name" required class="w-full admin-form-input" placeholder="Full name">
                    @error('name')
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" required class="w-full admin-form-input" placeholder="email@example.com">
                    @error('email')
                        <p class="mt-1 text-sm text-[#DC2626]">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-admin-text-muted mb-2">Password</label>
                    <input type="password" name="password" id="password" required class="w-full admin-form-input" placeholder="Secure password">
                    @error('password')
                        <p class="mt-1 text-sm text-[#DC2626]">{{ $message }}</p>
                    @enderror
                </div>
