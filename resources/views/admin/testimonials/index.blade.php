            ...
            <table class="min-w-full divide-y divide-admin-border-subtle">
                <thead>
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-semibold text-admin-text uppercase tracking-wider">Role</th>
                ...
                <tbody class="divide-y divide-admin-border-subtle">
                        ...
                        <tr class="transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($testimonial->is_featured)
                                    <span class="admin-badge admin-badge-featured" style="margin-right: 0.5rem;">
                                        Featured
                                    </span>
                                @endif
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-6 py-8 text-center text-admin-text-muted">
