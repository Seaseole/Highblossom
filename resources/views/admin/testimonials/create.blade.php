<x-layouts::admin title="Create Testimonial">
    <div class="p-6">
        <div class="admin-section-header">
            <h1 class="admin-section-title">Create Testimonial</h1>
        ...
        <form method="POST" action="{{ route('admin.testimonials.store') }}" class="max-w-2xl">
            @csrf
            ...
            <div class="bg-admin-surface-alt border border-admin-border rounded-xl p-6 space-y-4">
                <div>
                    ...
                    <input type="text" name="name" id="name" required class="w-full admin-form-input" placeholder="Customer name">
                    @error('name')
                ...
                <div>
                    ...
                    <input type="text" name="role" id="role" class="w-full admin-form-input" placeholder="e.g. CEO, Customer">
                    @error('role')
                        <p class="mt-1 text-sm text-admin-accent">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea name="content" id="content" rows="5" required class="w-full admin-form-input resize-none" placeholder="Customer testimonial"></textarea>
                    @error('content')
                        <p class="mt-1 text-sm text-admin-accent">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex items-center gap-3 p-4 bg-admin-surface-alt rounded-xl border border-admin-border">
                    ...
                    <input type="checkbox" name="is_featured" id="is_featured" value="1" class="h-5 w-5 bg-admin-input-bg border-admin-input-border rounded focus:ring-2 focus:ring-admin-accent cursor-pointer">
                ...
                <div class="flex items-center gap-3 p-4 bg-admin-surface-alt rounded-xl border border-admin-border">
                    ...
                    <input type="checkbox" name="is_published" id="is_published" value="1" checked class="h-5 w-5 bg-admin-input-bg border-admin-input-border rounded focus:ring-2 focus:ring-admin-accent cursor-pointer">
