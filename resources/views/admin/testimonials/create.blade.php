        ...
        <form method="POST" action="{{ route('admin.testimonials.store') }}" class="max-w-2xl">
            ...
            <div class="bg-admin-surface-alt border border-admin-border rounded-xl p-6 space-y-4">
                ...
                <div class="flex items-center gap-3 p-4 bg-admin-surface-alt rounded-xl border border-admin-border">
                    ...
                    <input type="checkbox" name="is_featured" id="is_featured" value="1" class="h-5 w-5 bg-admin-input-bg border-admin-input-border rounded focus:ring-2 focus:ring-[#DC2626] cursor-pointer">
                ...
                <div class="flex items-center gap-3 p-4 bg-admin-surface-alt rounded-xl border border-admin-border">
                    ...
                    <input type="checkbox" name="is_published" id="is_published" value="1" checked class="h-5 w-5 bg-admin-input-bg border-admin-input-border rounded focus:ring-2 focus:ring-[#DC2626] cursor-pointer">
