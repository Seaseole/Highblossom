<x-layouts::admin title="Create Service Type">
    <div class="p-6">
        <div class="admin-section-header">
            <h1 class="admin-section-title">Create Service Type</h1>
        ...
        <form method="POST" action="{{ route('admin.service-types.store') }}" class="max-w-2xl">
            @csrf
            ...
            <div class="bg-admin-surface-alt border border-admin-border rounded-xl p-6 space-y-4">
                <div>
                    ...
                    <input type="text" name="name" id="name" required class="w-full admin-form-input" placeholder="e.g. Replacement">
                    @error('name')
