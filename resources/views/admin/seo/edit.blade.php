    ...
    <div class="p-6">
        ...
        <div class="mb-8">
            <h1 class="font-headline text-3xl font-bold text-admin-text tracking-tight">
                Edit SEO: <span class="text-admin-accent">{{ $route_label }}</span>
            </h1>
            <p class="text-admin-text-muted text-sm mt-2">Update meta tags and search engine optimization</p>
        </div>

        <form method="POST" action="{{ route('admin.seo.update', $route->id) }}">
            @csrf
            @method('PUT')
                    ...
                    <div class="admin-glass-card rounded-3xl shadow-black/20 p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $route->meta_title) }}" maxlength="70" class="admin-form-input w-full" placeholder="Page title">
                                <p class="text-xs text-admin-text-muted mt-1">{{ strlen(old('meta_title', $route->meta_title ?? '')) }}/70 characters</p>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="meta_keywords" id="meta_keywords" value="{{ old('meta_keywords', $route->meta_keywords) }}" class="admin-form-input w-full" placeholder="keyword1, keyword2, keyword3">
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="meta_description" id="meta_description" rows="3" maxlength="300" class="admin-form-input w-full resize-none" placeholder="Brief description for search results">{{ old('meta_description', $route->meta_description) }}</textarea>
                                <p class="text-xs text-admin-text-muted mt-1">{{ strlen(old('meta_description', $route->meta_description ?? '')) }}/300 characters</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="admin-glass-card rounded-3xl shadow-black/20 p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="og_title" id="og_title" value="{{ old('og_title', $route->og_title) }}" maxlength="70" class="admin-form-input w-full" placeholder="Social sharing title">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="og_image" id="og_image" value="{{ old('og_image', $route->og_image) }}" class="admin-form-input w-full" placeholder="https://example.com/image.jpg">
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="og_description" id="og_description" rows="3" maxlength="300" class="admin-form-input w-full resize-none" placeholder="Description for social media sharing">{{ old('og_description', $route->og_description) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="admin-glass-card rounded-3xl shadow-black/20 p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="twitter_title" id="twitter_title" value="{{ old('twitter_title', $route->twitter_title) }}" maxlength="70" class="admin-form-input w-full" placeholder="Twitter sharing title">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="twitter_image" id="twitter_image" value="{{ old('twitter_image', $route->twitter_image) }}" class="admin-form-input w-full" placeholder="https://example.com/image.jpg">
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="twitter_description" id="twitter_description" rows="3" maxlength="300" class="admin-form-input w-full resize-none" placeholder="Description for Twitter cards">{{ old('twitter_description', $route->twitter_description) }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="admin-glass-card rounded-3xl shadow-black/20 p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="canonical_url" id="canonical_url" value="{{ old('canonical_url', $route->canonical_url) }}" class="admin-form-input w-full" placeholder="https://example.com/page">
                            </div>

                            <div>
                                <label for="robots" class="block text-xs font-semibold text-admin-text-muted uppercase tracking-wider mb-2">Robots</label>
                                <input type="text" name="robots" id="robots" value="{{ old('robots', $route->robots) }}" class="admin-form-input w-full" placeholder="index, follow">
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="priority" id="priority" step="0.1" min="0" max="1" value="{{ old('priority', $route->priority) }}" class="admin-form-input w-full" placeholder="0.5">
                                </div>
                            </div>
                            ...
                            <label class="flex items-center gap-3 p-4 bg-admin-surface-alt/50 rounded-xl border border-admin-border-subtle cursor-pointer hover:border-admin-accent/30 transition-colors">
                                <input type="checkbox" name="no_index" id="no_index" value="1" {{ old('no_index', $route->no_index) ? 'checked' : '' }} class="h-5 w-5 bg-admin-input-bg border-admin-border rounded focus:ring-2 focus:ring-admin-accent cursor-pointer">
                                <div>
