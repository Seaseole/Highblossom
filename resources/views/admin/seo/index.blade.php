                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/10">
                    @forelse ($routes as $route)
                        <tr class="transition-colors duration-200 hover:bg-gray-50 dark:hover:bg-white/5">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-300">
                                {{ $route['priority'] }}
                                <span class="text-xs text-gray-500">({{ $route['changefreq'] }})</span>
                            </td>
                            <td class="px-6 py-4 text-right">
                                <a
                                    href="{{ route($route['exists'] ? 'admin.seo.edit' : 'admin.seo.create', $route['exists'] ? $route['id'] : ['route_name' => $route['route_name']]) }}"
