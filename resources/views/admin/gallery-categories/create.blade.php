<x-layouts::admin title="Create Gallery Category">
    <div class="p-6">
        <div class="admin-section-header">
            <h1 class="admin-section-title">Create Gallery Category</h1>
        ...
        <form method="POST" action="{{ route('admin.gallery-categories.store') }}" class="max-w-2xl">
            @csrf
            ...
            <div class="bg-admin-surface-alt border border-admin-border rounded-xl p-6 space-y-4">
                <div>
                    ...
                    <input type="text" name="name" id="name" required class="w-full admin-form-input" placeholder="e.g. Automotive">
                    @error('name')
