<x-layouts::admin title="Create Gallery Category">
    <div class="p-8">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-4xl font-bold text-[#39393c] tracking-tight">Create Gallery Category</h1>
            <p class="mt-2 text-zinc-500">Add a new gallery category to the system</p>
        </div>

        <form method="POST" action="{{ route('admin.gallery-categories.store') }}" class="max-w-3xl">
            @csrf
            ...
            <div class="space-y-8">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="name" id="name" required class="w-full px-4 py-3 rounded-xl border border-zinc-200 bg-white text-zinc-900 placeholder-zinc-400 focus:border-[#dc2626] focus:ring-4 focus:ring-[#dc2626]/10 transition-all duration-200" placeholder="e.g. Automotive">
                        @error('name')
