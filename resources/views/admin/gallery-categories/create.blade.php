        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div class="space-y-1">
                <div class="flex items-center gap-3 text-admin-text-muted mb-2">
                    ...
                    <span class="text-[10px] font-bold uppercase tracking-[0.2em] font-body">Gallery Categories / New</span>
                </div>
                ...
                <p class="text-admin-text-muted text-sm max-w-lg">
                    Define a new architectural category to organize the showcase gallery.
                </p>
            </div>
        </div>

        <form method="POST" action="{{ route('admin.gallery-categories.store') }}" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            @csrf
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 gap-6">
                            <div class="space-y-2">
                                ...
                                <input type="text" name="name" id="name" required class="admin-form-input font-headline text-lg font-bold tracking-tight" placeholder="e.g. Architectural Aluminum">
                                @error('name')
            ...
            <div class="space-y-6">
                ...
                <div class="flex flex-col gap-3">
                    <button type="submit" class="admin-action-btn admin-action-btn-primary w-full justify-center py-4 shadow-lg shadow-admin-accent/20 focus:ring-admin-accent">
                        <span class="text-xs font-bold uppercase tracking-[0.2em]">Publish Category</span>
                    </button>
