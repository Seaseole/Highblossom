<x-layouts::admin title="Glass Types">
    <div class="p-6">
        <div class="admin-section-header">
            <h1 class="admin-section-title">Glass Types</h1>
            <a href="{{ route('admin.glass-types.create') }}" class="admin-action-btn admin-action-btn-primary">
                    ...
                    @forelse($glassTypes as $glassType)
                        <tr class="transition-colors duration-200">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-admin-text">{{ $glassType->name }}</div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="{{ route('admin.glass-types.edit', $glassType) }}" class="admin-action-btn admin-action-btn-secondary">
                                    Edit
                                </a>
                            </td>
                        </tr>
