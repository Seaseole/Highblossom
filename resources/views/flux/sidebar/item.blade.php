...
<flux:tooltip :position="$tooltipPosition">
    <flux:button-or-link :attributes="$attributes->class($classes)" data-flux-sidebar-item>
        ...
        <flux:icon
            :icon="$iconTrailing"
            :variant="$iconVariant"
            class="size-4! in-data-flux-sidebar-collapsed-desktop:not-in-data-flux-sidebar-group-dropdown:hidden"
        />
    ...
    <flux:tooltip.content
        :kbd="$tooltipKbd"
        class="cursor-default not-in-data-flux-sidebar-collapsed-desktop:hidden in-data-flux-sidebar-group-dropdown:hidden"
    >
        {{ $tooltip }}
    </flux:tooltip.content>
</flux:tooltip>
