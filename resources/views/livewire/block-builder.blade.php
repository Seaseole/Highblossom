        ...
        @else
            <template x-for="(block, index) in blocks" :key="block.id || index">
                ...
                >
                    ...
                    <!-- Edit Panel -->
                    <div x-show="editingIndex === index" x-transition class="mt-4 pt-4 border-t border-gray-100 dark:border-white/10">
                        <!-- Paragraph -->
                                ...
                                <template x-if="videoMode === 'url'">
                                    <div class="space-y-3">
                                        <div class="relative rounded-lg overflow-hidden bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 aspect-video flex items-center justify-center">
                                            <template x-if="videoPreviewState === 'empty'"><p class="text-sm text-gray-500">Paste a video URL</p></template>
                                            <template x-if="videoPreviewState === 'loading'"><p class="text-sm text-gray-500">Detecting...</p></template>
