        ...
        >
            ...
            <nav class="flex-1 overflow-y-auto p-4">
                <a
                    ...
                    class="flex items-center gap-3 py-2 px-4 rounded hover:bg-gray-100 transition-colors {{ request()->routeIs('dashboard') ? 'bg-gray-200' : '' }}"
                ...
                <a
                    ...
                    class="flex items-center gap-3 py-2 px-4 rounded hover:bg-gray-100 transition-colors {{ request()->routeIs('admin.users.*') ? 'bg-gray-200' : '' }}"
                ...
                <a
                    ...
                    class="flex items-center gap-3 py-2 px-4 rounded hover:bg-gray-100 transition-colors {{ request()->routeIs('admin.roles.*') ? 'bg-gray-200' : '' }}"
                ...
                <a
                    ...
                    class="flex items-center gap-3 py-2 px-4 rounded hover:bg-gray-100 transition-colors {{ request()->routeIs('admin.seo.*') ? 'bg-gray-200' : '' }}"
                ...
                <a
                    ...
                    class="flex items-center gap-3 py-2 px-4 rounded hover:bg-gray-100 transition-colors {{ request()->routeIs('admin.media-library.*') ? 'bg-gray-200' : '' }}"
                ...
                <a
                    ...
                    class="flex items-center gap-3 py-2 px-4 rounded hover:bg-gray-100 transition-colors {{ request()->routeIs('admin.posts.*') ? 'bg-gray-200' : '' }}"
                ...
                <a
                    ...
                    class="flex items-center gap-3 py-2 px-4 rounded hover:bg-gray-100 transition-colors {{ request()->routeIs('admin.categories.*') ? 'bg-gray-200' : '' }}"
                ...
                <a
                    ...
                    class="flex items-center gap-3 py-2 px-4 rounded hover:bg-gray-100 transition-colors {{ request()->routeIs('admin.tags.*') ? 'bg-gray-200' : '' }}"
        ...
        >
            ...
            <nav class="flex-1 overflow-y-auto p-4">
                <a
                    href="{{ route('dashboard') }}"
                    @click="mobileMenuOpen = false"
                    class="block py-2 px-4 rounded hover:bg-gray-100 transition-colors {{ request()->routeIs('dashboard') ? 'bg-gray-200' : '' }}"
                >
                    Dashboard
                </a>
                <a
                    href="{{ route('admin.users.index') }}"
                    @click="mobileMenuOpen = false"
                    class="block py-2 px-4 rounded hover:bg-gray-100 transition-colors {{ request()->routeIs('admin.users.*') ? 'bg-gray-200' : '' }}"
                >
                    Users
                </a>
                <a
                    href="{{ route('admin.roles.index') }}"
                    @click="mobileMenuOpen = false"
                    class="block py-2 px-4 rounded hover:bg-gray-100 transition-colors {{ request()->routeIs('admin.roles.*') ? 'bg-gray-200' : '' }}"
                >
                    Roles
                </a>
                <a
                    href="{{ route('admin.seo.static-routes') }}"
                    @click="mobileMenuOpen = false"
                    class="block py-2 px-4 rounded hover:bg-gray-100 transition-colors {{ request()->routeIs('admin.seo.*') ? 'bg-gray-200' : '' }}"
                >
                    SEO
                </a>
                <a
                    href="{{ route('admin.media-library.index') }}"
                    @click="mobileMenuOpen = false"
                    class="block py-2 px-4 rounded hover:bg-gray-100 transition-colors {{ request()->routeIs('admin.media-library.*') ? 'bg-gray-200' : '' }}"
                >
                    Media Library
                </a>
                <div class="mt-4 mb-2 px-4">
                ...
                <a
                    href="{{ route('admin.posts.index') }}"
                    @click="mobileMenuOpen = false"
                    class="block py-2 px-4 rounded hover:bg-gray-100 transition-colors {{ request()->routeIs('admin.posts.*') ? 'bg-gray-200' : '' }}"
                >
                    Posts
                </a>
                <a
                    href="{{ route('admin.categories.index') }}"
                    @click="mobileMenuOpen = false"
                    class="block py-2 px-4 rounded hover:bg-gray-100 transition-colors {{ request()->routeIs('admin.categories.*') ? 'bg-gray-200' : '' }}"
                >
                    Categories
                </a>
                <a
                    href="{{ route('admin.tags.index') }}"
                    @click="mobileMenuOpen = false"
                    class="block py-2 px-4 rounded hover:bg-gray-100 transition-colors {{ request()->routeIs('admin.tags.*') ? 'bg-gray-200' : '' }}"
                >
                    Tags
                </a>
            </nav>
